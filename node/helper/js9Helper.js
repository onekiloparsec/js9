...
let plugins = [];
// keep installDir anchored to repository/web root even if this module is moved
...
// globalOpts that might need to have paths relative to installDir
...
const loadPreferences = function(prefs){
	...
	if( obj && typeof obj.globalOpts === "object" ){
		...
		// some directories should be relative to installDir
...
const mergeDirectory = function(dir){
    ...
    mergeTo = path.relative(installDir, dir);
