...
this.onSettledCallbacks_=null}};var f=new c;e.prototype.settleSameAsPromise_=function(a){var b=this.createResolveAndReject_();a.callWhenSettled_(b.resolve,b.reject)};e.prototype.settleSameAsThenable_=function(a,b){var c=this.createResolveAndReject_();try{a.call(b,c.resolve,c.reject)}catch(m){c.reject(m)}};e.prototype.then=function(a,b){function c(a,b){return"function"==typeof a?function(b){try{d(a(b))}catch(x){f(x)}}:b}var d,f,g=new e(function(a,b){d=a;f=b});this.callWhenSettled_(c(a,d),c(b,f));return g};
...
d)})};e.all=function(a){var c=$jscomp.makeIterator(a),d=c.next();return d.done?b([]):new e(function(a,e){function f(b){return function(c){g[b]=c;h--;0==h&&a(g)}}var g=[],h=0;do g.push(void 0),h++,b(d.value).callWhenSettled_(f(g.length-1),e),d=c.next();while(!d.done)})};return e},"es6","es3");var Module;"object"!==typeof Module&&(Module={});
...
imopts:"IMOPTS",imcmap:"IMCMAP",fixiURL:"node_modules/@onekiloparsec/fixi-js/dist/fixi.js",fixiWasmURL:"node_modules/@onekiloparsec/fixi-js/dist/fixi_core.wasm",fitsAdapter:"fixi",fitsCompliance:"strict",table:{xdim:4096,ydim:4096,bin:1,bitpix:32},image:{xdim:4096,ydim:4096,bin:1},binMode:"s",reprojSwitches:"",reprojectLimits:!1,rotationCenter:"file",runOnCR:!0,clearImageMemory:"heap",helperProtocol:location.protocol,reloadRefresh:!1,reloadRefreshReg:!0,nextImageMask:!1,panMouseThreshold:1,panzoomRefreshLimit:500,
panWithinDisplay:!1,pannerDirections:!0,magnifierRegions:!0,editRegions:!0,svgBorder:!0,unremoveReg:100,resetEmptyShapeId:!1,maxMemory:2E9,loadURL:"params/load.html",corsURL:"params/loadcors.html",proxyURL:"params/loadproxy.html",loadProxy:!1,imsectionURL:"params/imsection.html",postMessage:!1,localStorage:!0,waitType:"spinner",spinColor:"#FF0000",spinOpacity:.35,resize:!0,resizeHandle:!0,resizeRedisplay:!0,logoDisplay:!1,logo:"images/js9logo.png",lightWinPos:"center=1",lightWinClose:"ask",fallbackDisplay:!0,
...
s:"select region",S:"select all regions","M-s":"toggle shape layers plugin",u:"undo remove of region(s)",U:"unselect all regions",x:"flip image around x axis",y:"flip image around y axis",9:"rotate image by 90 degrees","/":"copy wcs position to clipboard","?":"copy value and position to clipboard",0:"reset zoom","=":"zoom in","+":"zoom in","-":"zoom out","^":"raise region layer to top",">":"display next image","<":"display previous image","delete":"remove selected region",leftArrow:"move region/position left",
upArrow:"move region/position up",rightArrow:"move region/position right",downArrow:"move region/position down"},mousetouchZoom:!1,mousetouchLimit:!0,metaClickPan:!0,statusBar:"$colorbar; $colormap; $mag; $scale ($scalemin,$scalemax); $wcssys; $image0",statusBarDictionary:{},toolbarTooltips:!1,updateTitlebar:!0,centerDivs:["JS9Menubar"],resizeDivs:["JS9Menubar","JS9Colorbar","JS9Toolbar","JS9Statusbar"],pinchWait:8,pinchThresh:6,xeqPlugins:!0,extendedPlugins:!0,intensivePlugins:!1,dynamicSelect:"click",
dynamicHighlight:!0,corsProxy:"https://js9.si.edu/cgi-bin/CORS-proxy.cgi",simbadProxy:"https://js9.si.edu/cgi-bin/simbad-proxy.cgi",cgiProxy:"https://js9.si.edu/cgi-bin/FITS-proxy.cgi",catalogs:{ras:["RA","_RAJ2000","RAJ2000"],decs:["Dec","_DEJ2000","DEJ2000"],shape:"circle",color:"yellow",width:7,height:7,radius:3.5,r1:5,r2:3.5,wcssys:"ICRS",skip:"#\n",save:!0,tooltip:"$data.ra $data.dec"},topColormaps:"grey heat cool turbo viridis magma sls red green blue".split(" "),infoBox:"file object wcsfov wcscen wcspos impos physpos value regions progress".split(" "),
infoBoxResize:!0,menuBar:"file edit view zoom scale color region wcs analysis help".split(" "),menubarStyle:"classic",menuPosition:"right-5 bottom-5",menuClickEvent:"mouseup",menuSelected:"check",menuImages:!0,userMenus:!1,userMenuDivider:"&nbsp;&nbsp;&nbsp;",imagesFileSubmenu:5,toolBar:"annulus box circle ellipse line polygon text zoom+ zoom- zoom1 zoomtofit".split(" "),syncOps:"alignment colormap contrastbias flip pan regions rotate rot90 scale wcs zoom".split(" "),syncReciprocate:!0,syncWCS:!0,
hiddenPluginDivs:[],separate:{layout:"auto",leftMargin:10,topMargin:10},imageTemplates:".fits,.fts,.png,.jpg,.jpeg,.fz,.ftz,.gz",wcsUnits:{FK4:"sexagesimal",FK5:"sexagesimal",ICRS:"sexagesimal",galactic:"degrees",ecliptic:"degrees",linear:"degrees",physical:"pixels",image:"pixels"},wcsSetUpdatesDef:!0,wcsHlength:256E3,regTemplates:".reg",sessionTemplates:".ses,.js9ses",colormapTemplates:".cmap",catalogTemplates:".cat,.tab",localTemplates:".fits,.fts",controlsMatchRegion:!1,internalColorPicker:!0,
newWindowWidth:530,newWindowHeight:625,debug:0};a.favorites={scales:["linear","log","histeq"],colormaps:["cool","heat","viridis","magma"],regions:["annulus","box","circle","ellipse"],wcs:["FK5","ICRS","galactic:Galactic","physical","image"]};a.desktopOpts={currentPath:!0,sessionPath:!0};a.imageOpts={inherit:!1,contrast:1,bias:.5,invert:!1,exp:1E3,colormap:"grey",overlay:!0,scale:"linear",scaleclipping:"dataminmax",scalemin:Number.NaN,scalemax:Number.NaN,flip:"none",rot90:0,rotate:0,zscalecontrast:.25,
zscalesamples:600,zscaleline:120,wcssys:"native",lcs:"physical",valpos:!0,sigma:"none",opacity:1,alpha:255,nancolor:"#000000",nocolor:{red:0,green:0,blue:0,alpha:0},zoom:1,zooms:6,topZooms:2,wcsalign:!0,rotationMode:"relative",crosshair:!1,disable:[],ltvbug:!1,listonchange:!1,whichonchange:"selected"};a.regionOpts={};a.catalogOpts={};a.crosshairOpts={};a.gridOpts={};a.emscriptenOpts={};a.fabricOpts={};a.socketioOpts={reconnection:!0,reconnectionDelay:1E3,reconnectionDelayMax:1E4,reconnectionAttempts:100,
timeout:a.globalOpts.htimeout};a.blendOpts={active:!0,mode:"screen",opacity:1};a.maskOpts={active:!1,mode:"overlay",opacity:1,vopacity:0,value:0,syncops:["flip","pan","rot90","zoom"],invert:!1};a.analOpts={epattern:/^(ERROR:[^\n]*)\n/,dpathURL:"params/datapath.html",fpathURL:"params/filepath.html"};a.lightOpts={nclick:0,dhtml:{topid:"#dhtmlwindowholder",top:".dhtmlwindow",drag:".drag-contentarea",dragBar:".drag-handle",format:"width=%spx,height=%spx,resize=%s,scrolling=0",textWin:"width=830px,height=400px,resize=1,scrolling=1",
plotWin:"width=830px,height=420px,resize=1,scrolling=1",dpathWin:"width=830px,height=175px,resize=1,scrolling=1",lcloseWin:"width=512px,height=190px,resize=1,scrolling=1",paramWin:"width=830px,height=235px,resize=1,scrolling=1",regWin0:"width=640px,height=130px,resize=1,scrolling=1",regWin1:"width=640px,height=200px,resize=1,scrolling=1",regWin:"width=640px,height=470px,resize=1,scrolling=1",imageWin:"width=512px,height=598px,resize=1,scrolling=1",lineWin:"width=400px,height=60px,resize=1,scrolling=1"},
...
"width=660px,height=470px,resize=1,scrolling=1");({}).hasOwnProperty.call(window,"Jupyter")&&(a.globalOpts.useWasm=!1);if(window.electron){window.electron.hostFS&&(a.hostFS=window.electron.hostFS);window.electron.multiElectron&&(a.globalOpts.localStorage=!1);"function"===typeof window.eval&&(window.eval=function(){throw Error("For security reasons, Desktop JS9 does not support window.eval()");});if(window.electron.cmdlineOpts)try{a.cmdlineOpts=JSON.parse(window.electron.cmdlineOpts)}catch(c){delete a.cmdlineOpts}window.electron.guiOpts&&
(a.Voyager=window.electron.guiOpts.voyager,a.localRootDir=window.electron.guiOpts.localRootDir)}a.Image=function(c,b,d){var e=this,f=null,g=0,h=0,k=function(b){b=b||{};a.isNull(b.scaleclipping)?"zscale"===e.params.scaleclipping?e.zscale(!0):"zmax"===e.params.scaleclipping&&e.zscale("zmax"):"zscale"===b.scaleclipping?e.zscale(!0):"zmax"===b.scaleclipping&&e.zscale("zmax");a.notNull(b.scalemin)&&(e.params.scalemin=b.scalemin);a.notNull(b.scalemax)&&(e.params.scalemax=b.scalemax)},m=function(b){var c=
a.globalOpts.imopts,d=a.globalOpts.imcmap,g=a.globalOpts.alerts;var h=/(annulus|box|circle|ellipse|line|polygon|point|text) *\(/;a.images.push(e);e.display.clearMessage();f&&(a.notNull(f.flip)||a.notNull(f.rotate)||a.notNull(f.rot90))&&e.setTransform();e.displayImage("all",f);e.notifyHelper();e.showShapeLayer("regions",!0,{local:!0});f&&((a.notNull(f.x)&&a.notNull(f.y)||a.notNull(f.px)&&a.notNull(f.py)||a.notNull(f.ra)&&a.notNull(f.dec)||a.notNull(f.wcs))&&e.setPan(f),f.regions&&(f.regions.match(h)?
e.addShapes("regions",f.regions):a.LoadRegions(f.regions,{display:e.display})));a.globalOpts.alerts=!1;if(e.raw&&e.raw.header&&e.raw.header[d]){try{var k=JSON.parse(e.raw.header[d])}catch(y){k=null}if(k)try{a.AddColormap(k)}catch(y){}}if(e.raw&&e.raw.header&&e.raw.header[d+"1"]){var l=1;for(h="";100>l;l++){var m=d+String(l);if(e.raw.header[m])h+=e.raw.header[m];else break}if(h){try{k=JSON.parse(h)}catch(y){k=null}if(k)try{a.AddColormap(k)}catch(y){}}}if(e.raw&&e.raw.header&&e.raw.header[c]){try{k=
...
height:this.raw.height,bitpix:this.raw.bitpix,bin:this.binning.bin,header:this.raw.header,hdus:this.hdus,dwidth:this.display.width,dheight:this.display.height,fwidth:e,fheight:c,data:b}};a.Image.prototype.closeImage=function(c){var b,d,e=!1;var f=a.images.length;var g=a.Dysel.getDisplayOr(this.display);c=c||{};if("string"===typeof c)try{c=JSON.parse(c)}catch(h){a.error("can't parse closeImage opts: "+c,h)}this.setStatus("close","closing");for(b=0;b<f;b++)a.images[b].wcsim===this&&(a.images[b].wcsim=
null);for(b=0;b<f;b++)a.images[b].mask.im===this&&(a.images[b].mask.im=null,a.images[b].mask.active=!1);for(b=0;b<f;b++)if(this===a.images[b]){f=a.images[b];f===f.display.image&&(e=b+1);if(e)for(!1!==c.clear&&(f.display.clearMessage(),f.display.context.clear()),c=$jscomp.makeIterator(Object.keys(f.layers)),d=c.next();!d.done;d=c.next())d=d.value,"main"!==f.layers[d].dlayer.dtype&&f.display!==g||f.showShapeLayer(d,!1,{local:!0});f.xeqPlugins("image","onimageclose");e&&(f.display.image=null);switch(f.cmapObj.name){case "red":f.display.rgb.rim=
null;break;case "green":f.display.rgb.gim=null;break;case "blue":f.display.rgb.bim=null}for(g=0;g<f.raws.length;g++)c=f.raws[g],c.hdu&&c.hdu.fits&&(d=a.lookupVfile(c.hdu.fits.vfile),1>=d.length&&a.cleanupFITSFile(c,!0)),c.altwcs&&this.freeWCS(c);f.removeProxyFile();f.rgb=null;f.offscreen=null;f.raw=null;f.colorData=null;f.colorCells=null;f.psColors=null;f.psInverse=null;a.images.splice(b,1);break}if(e){for(b=e-=2;0<=b;b--)if(f=a.images[b],this.display===f.display){f.displayImage("all");f.refreshLayers();
e=a.images.length;break}for(b=a.images.length-1;b>e;b--)if(f=a.images[b],this.display===f.display){f.displayImage("all");f.refreshLayers();break}}};a.Image.prototype.mkOffScreenCanvas=function(){if(!this.png||!this.png.image)return this;this.offscreen={};this.offscreen.canvas=document.createElement("canvas");this.offscreen.canvas.setAttribute("width",this.png.image.width);this.offscreen.canvas.setAttribute("height",this.png.image.height);this.offscreen.context=this.offscreen.canvas.getContext("2d");
...
{},a.Image.prototype.initLCS.call(this.parent,this.parent.raw.header));if("image"===m.imtab&&void 0!==m.x1&&1!==m.x1||void 0!==m.y1&&1!==m.y1||void 0===m.bin||1!==m.bin)h=a.defNull(m.x1,1),k=a.defNull(m.y1,1),f=m.bin||1,0>f&&(f=1/Math.abs(f)),a.notNull(e.NAXIS1)&&(e.NAXIS1/=f),a.notNull(e.NAXIS2)&&(e.NAXIS2/=f),a.notNull(e.CRPIX1)&&(e.CRPIX1=(e.CRPIX1+1-h-.5)/f+.5),a.notNull(e.CRPIX2)&&(e.CRPIX2=(e.CRPIX2+1-k-.5)/f+.5),a.notNull(e.CDELT1)&&(e.CDELT1*=f),a.notNull(e.CDELT2)&&(e.CDELT2*=f),a.notNull(e.CD1_1)&&
...
0;h<g;h++)u+=l[h];p=u/g;for(h=m=0;h<g&&m<g;h++)for(this.hist[h]=m/g,c+=l[h];c>=p&&m<g;)c-=p,m++;for(c=(g-1)/g;h<g;)this.hist[h++]=c}for(h=0;h<e;h++)c=this.hist[h*g/e],c=Math.floor(c*d),this.psColors[h]=this.colorCells[c];for(h=0;h<f;h++){d=h/f;for(p=0;p<g-1&&!(this.hist[p]>d);p++);c=p/g;this.psInverse[h]=c*k+b}break;default:a.error("unknown scale '"+this.params.scale+"'")}return this};a.Image.prototype.mkRGBImage=function(){var c,b,d,e,f=!1,g=null,h=null,k=null,m=!1,l=!1,p=!1,r=!1,n=[];if(!this.rgb)return this;
!this.display.rgb.active||this!==this.display.rgb.rim&&this!==this.display.rgb.gim&&this!==this.display.rgb.bim||(m=!0,this.display.rgb.rim&&(g=this.display.rgb.rim),this.display.rgb.gim&&(h=this.display.rgb.gim),this.display.rgb.bim&&(k=this.display.rgb.bim));var u=this.display.context;var x=this.rgb;var t=x.sect;if(this.MakeRGBImage&&"function"===typeof this.MakeRGBImage&&this.MakeRGBImage()||this.MakePrimaryImage&&"function"===typeof this.MakePrimaryImage&&this.MakePrimaryImage())return this;if(this.useOffScreenCanvas()){var v=
t.width/t.zoom;var w=t.height/t.zoom;var q=t.x0;var z=this.offscreen.canvas.height-1-(t.y0+w);z=this.offscreen.context.getImageData(q,z,v,w);if(1===t.zoom)x.img=z;else for(x.img=u.createImageData(t.width,t.height),x=x.img,d=c=0;c<z.height;c++,d++){var y=c*z.width;var A=d*t.zoom;for(b=u=0;u<z.width;u++,b++){q=4*(y+u);var C=b*t.zoom;for(e=0;e<t.zoom;e++){var B=Math.floor(A+e);var D=B*t.width;for(B=0;B<t.zoom;B++){var E=Math.floor(C+B);E=4*(D+E);x.data[E]=z.data[q];x.data[E+1]=z.data[q+1];x.data[E+2]=
z.data[q+2];x.data[E+3]=z.data[q+3]}}}}return this}x.img&&x.img.width===t.width&&x.img.height===t.height||(x.img=u.createImageData(t.width,t.height));x=x.img;var F=x.data.length-4;if(!this.psColors&&!this.staticObj)return this;var G=void 0!==this.params.opacity?Math.floor(255*this.params.opacity):void 0!==this.params.alpha?this.params.alpha:255;if(this.mask.active&&this.mask.im){var J=this.mask.im;if("mask"===this.mask.mode){l=!0;var I=a.notNull(this.mask.vopacity)?255*this.mask.vopacity:0;var K=
a.notNull(this.params.opacity)?255*this.params.opacity:255;this.mask.invert&&(G=I,I=K,K=G)}else if("opacity"===this.mask.mode)p=!0;else if("overlay"===this.mask.mode){r=!0;var L=J.rgb.img;a.isNull(this.mask.opacity)&&(this.mask.opacity=1)}}else if(a.notNull(this.params.flooropacity)&&!m){var R=255*this.params.flooropacity;var M=this.params.floorvalue;f=!0}var N=Math.max(1,Math.floor(1/t.zoom));var P=t.zoom*N;c=Math.floor(t.y1-1);for(d=0;c>=t.y0;c-=N,d++)for(y=c*this.raw.width,A=d*P,u=Math.floor(t.x0),
b=0;u<t.x1;u+=N,b++){l?G=J.raw.data[y+u]>this.mask.value?K:I:p&&(G=255*J.raw.data[y+u]);if(m){if(z=g?g.colorData[y+u]:0,v=h?h.colorData[y+u]:0,w=k?k.colorData[y+u]:0,a.isNull(z)||a.isNull(v)||a.isNull(w))return this.display.rgb.active=!1,a.error("RGB images are incompatible. Turning off RGB mode.","",!1),this.mkRGBImage(),this}else this.staticObj||(q=this.colorData[y+u]);var Q=G;f&&this.raw.data[y+u]<=M&&(Q=R);C=b*P;for(e=0;e<t.zoom;e++)for(B=Math.ceil(A+e),D=B*t.width,B=0;B<t.zoom;B++)if(E=Math.ceil(C+
B),E=4*(D+E),E<=F)if(m)x.data[E]=g?g.psColors[z][0]:0,x.data[E+1]=h?h.psColors[v][1]:0,x.data[E+2]=k?k.psColors[w][2]:0,x.data[E+3]=G;else if(this.staticObj){var H=this.raw.data[y+u];H=a.lookupStaticColor(this,H,n);x.data[E]=H.red;x.data[E+1]=H.green;x.data[E+2]=H.blue;x.data[E+3]=H.alpha}else if(void 0!==this.psColors[q])if(r&&L.data[E+3]){H=L.data[E+3]/255*this.mask.opacity;var O=1-H;x.data[E]=L.data[E]*H+this.psColors[q][0]*O;x.data[E+1]=L.data[E+1]*H+this.psColors[q][1]*O;x.data[E+2]=L.data[E+
2]*H+this.psColors[q][2]*O;x.data[E+3]=255}else x.data[E]=this.psColors[q][0],x.data[E+1]=this.psColors[q][1],x.data[E+2]=this.psColors[q][2],x.data[E+3]=Q}return this};a.Image.prototype.blendImage=function(c){for(var b=[],d=0;d<arguments.length;++d)b[d-0]=arguments[d];var e=$jscomp.makeIterator(b);d=e.next().value;var f=e.next().value;e=e.next().value;var g=/normal|multiply|screen|overlay|darken|lighten|color-dodge|color-burn|hard-light|soft-light|difference|exclusion|hue|saturation|color|luminosity|clear|copy|source-over|destination-over|source-in|destination-in|source-out|destination-out|source-atop|destination-atop|xor|lighter/i;
...
a.notNull(e)&&("true"===e?e=!0:"false"===e&&(e=!1),this.blend.active=e),this.xeqPlugins("image","onimageblend"),this.display.blendMode&&this.blend.active&&this.displayImage();return this};a.Image.prototype.maskImage=function(c){for(var b=[],d=0;d<arguments.length;++d)b[d-0]=arguments[d];d=$jscomp.makeIterator(b);var e=d.next().value;d=d.next().value;var f;if(!b.length)return this.mask;if(!0===e||!1===e||"true"===e||"false"===e)return"true"===e?e=!0:"false"===e&&(e=!1),this.mask.active=e,this.xeqPlugins("image",
"onimagemask"),this.displayImage(),this;if("string"===typeof e&&"{"===e.charAt(0))try{e=JSON.parse(e)}catch(g){a.error("can't parse JSON in maskImage: "+e,g)}a.isImage(e)||d||(d=e,e=null);e&&((f=a.lookupImage(e))||a.error("unknown image for maskImage: "+e),this.raw.width===f.raw.width&&this.raw.height===f.raw.height||a.error("maskImage: mask dims ("+f.raw.width+","+f.raw.height+") don't match image dims ("+this.raw.width+","+this.raw.height+")"),this.mask.im=f,this.mask.active=!0);if(d){if("string"===
typeof d)try{d=JSON.parse(d)}catch(g){a.error("can't parse JSON in maskImage: "+d,g)}b=$jscomp.makeIterator(Object.keys(d));for(e=b.next();!e.done;e=b.next())switch(e=e.value,e){case "opacity":this.mask.vopacity=d[e];break;default:this.mask[e]=d[e]}}!f||d&&!1===d.sync||"function"!==typeof this.syncImages||this.syncImages(this.mask.syncops,[f]);(f||d)&&this.displayImage()};a.Image.prototype.calcDisplayOffsets=function(c){var b=this.rgb.sect;this.ix=(this.display.canvas.width-this.rgb.img.width)/2;
this.iy=(this.display.canvas.height-this.rgb.img.height)/2;a.notNull(b.ix)&&(this.ix-=b.ix/2);a.notNull(b.iy)&&(this.iy+=b.iy/2);this.ix=Math.floor(this.ix);this.iy=Math.floor(this.iy);if(c&&this.wcsAlign()){var d=this.wcsim;c=d.rgb.sect;d=a.pix2pix(d,this,d.getPan());var e=a.globalOpts.panWithinDisplay;a.globalOpts.panWithinDisplay=!0;this.tmp.ozoom=this.rgb.sect.ozoom;this.mkSection(d.x,d.y,c.zoom);this.rgb.sect.ozoom=this.tmp.ozoom;delete this.tmp.ozoom;a.globalOpts.panWithinDisplay=e;this.ix-=
(b.xcen-(b.x0+b.x1)/2)*c.zoom;this.iy+=(b.ycen-(b.y0+b.y1)/2)*c.zoom}return this};a.Image.prototype.putImage=function(c){var b=this,d=this.rgb,e=this.display.context;c=c||{};"reproject"===this.rawDataLayer()&&c.wcsim&&(this.wcsim=c.wcsim,this.wcsim.isawcsim=!0);this.calcDisplayOffsets(!0);e.save();void 0!==c.opacity&&(e.globalAlpha=c.opacity);void 0!==c.blend&&(e.globalCompositeOperation=c.blend);if(this.params.transform){c=this.params.transform;var f=this.display.width/2;var g=this.display.height/
2;e.translate(f,g);e.transform(c[0][0],c[0][1],c[1][0],c[1][1],c[2][0],c[2][1]);e.translate(-f,-g)}e.drawImage(function(c){if(!b.offscreenRGB){var d=document.createElement("canvas");var e=d.getContext("2d");a.ANTIALIAS||(e.imageSmoothingEnabled=!1);b.offscreenRGB={canvas:d,context:e}}b.offscreenRGB.canvas.width=c.width;b.offscreenRGB.canvas.height=c.height;b.offscreenRGB.context.putImageData(c,0,0);return b.offscreenRGB.canvas}(d.img),this.ix,this.iy);e.restore();return this};a.Image.prototype.displayImage=
...
typeof m.separate){g=m.separate.split(":");switch(g.length){case 1:e=g[0];break;default:e=g[0],m.id=g[1]}m.display=a.lookupDisplay(e)}else m.display=d.display;"parentFile"===f&&d.fitsFile&&(e=a.lookupImage(d.fitsFile),m.parentFile=e&&e.parentFile?e.parentFile:d.fitsFile);h=d.listRegions("all",{mode:1,includedcoords:!0,ignoreignore:!0,saveediting:!0,savewcsconfig:!0,sortids:!1,saveid:!0});b=m.ondisplaysection||m.onrefresh||b;k=new a.Image(c,m,b);k.binning.obin=k.binning.bin;h&&!1!==m.refreshRegions&&
k.addShapes("regions",h,{restoreid:!0});d.reFlipRot();k.setStatus("displaySection","complete")}else if("string"===typeof m.refresh){delete m.xcen;delete m.ycen;g=m.refresh.split(":");switch(g.length){case 1:e=g[0];break;default:e=g[0],m.id=g[1]}m.display=a.lookupDisplay(e);m.display.image?(m.rawid=d.raw.id,m.onrefresh=m.ondisplaysection||m.onrefresh||b,m.display.image.refreshImage(c,m)):("parentFile"===f&&d.fitsFile&&(e=a.lookupImage(d.fitsFile),m.parentFile=e&&e.parentFile?e.parentFile:d.fitsFile),
h=d.listRegions("all",{mode:1,includedcoords:!0,ignoreignore:!0,saveediting:!0,savewcsconfig:!0,sortids:!1,saveid:!0}),b=m.ondisplaysection||m.onrefresh||b,k=new a.Image(c,m,b),k.binning.obin=k.binning.bin,h&&k.addShapes("regions",h,{restoreid:!0}),d.reFlipRot())}else m.rawid=d.raw.id,m.onrefresh=m.ondisplaysection||m.onrefresh||b,d.refreshImage(c,m);d.setStatus("displaySection","complete");a.waiting(!1)};this.raw&&this.raw.hdu&&this.raw.hdu.fits||a.error("invalid image for displaySection");c=c||
{};if("full"===c){var n=this.fileDimensions();c={xdim:n.xdim,ydim:n.ydim,xcen:0,ycen:0}}else{if("selected"===c){this._selectShapes("regions","selected",null,function(a){a=a.pub;var c,e=0,f=0,g=1E6,h=0,k=1E6,l=0,n=a.shape;if(!d.parentFile&&a.lcs){a=a.lcs;var r=a.x;var p=a.y;if(c=d.maybePhysicalToImage({x:r,y:p}))r=c.x,p=c.y}else r=a.x,p=a.y;switch(n){case "annulus":var u=2*a.radii[a.radii.length-1];var x=2*a.radii[a.radii.length-1];break;case "box":u=a.width;x=a.height;break;case "circle":u=2*a.radius;
x=2*a.radius;break;case "cross":u=a.width;x=a.height;break;case "ellipse":u=2*a.r1;x=2*a.r2;break;case "polygon":case "line":for(u=0;u<a.pts.length;u++)e+=a.pts[u].x,f+=a.pts[u].y,a.pts[u].x>h&&(h=a.pts[u].x),a.pts[u].x<g&&(g=a.pts[u].x),a.pts[u].y>l&&(l=a.pts[u].y),a.pts[u].y<k&&(k=a.pts[u].y);a.x=e/a.pts.length;a.y=f/a.pts.length;"line"===a.shape&&2===a.pts.length?(u=Math.sqrt((a.pts[0].x-a.pts[1].x)*(a.pts[0].x-a.pts[1].x)+(a.pts[0].y-a.pts[1].y)*(a.pts[0].y-a.pts[1].y)),x=1):(u=h-g,x=l-k);break;
case "text":x=u=10}m={xcen:r,ycen:p,xdim:u,ydim:x,from:"virtualFile",separate:!0,refreshRegions:!1,resetSection:!0};d.displaySection(m,b)});return}if("string"===typeof c)try{c=JSON.parse(c)}catch(v){a.error("can't parse displaySection opts: "+c,v)}}c.cubecol=c.cubecol||"";if(c.cubecol){var u=this.file.split("/").reverse()[0].replace(/\[.*\]/,"").replace(".fits","_cube_"+c.cubecol+".fits").replace(/\.ftz$/,"_cube_"+c.cubecol+".fits").replace(/\.gz$/,"").replace(/\.bz2$/,"").replace(/:/g,"_");c.file||
(c.file=u);c.id||(c.id=u);!1!==c.separate&&(c.separate=!0)}var x=c.separate?$.extend(!0,{},this.raw.hdu):this.raw.hdu;(f=c.from)||(f=this.parentFile&&a.helper.connected&&a.helper.js9helper?"parentFile":"virtualFile");if("table"===this.imtab&&x.table)n=x.table;else{n={};n.bin=x.bin||1;"parentFile"===f&&this.raw.header&&a.notNull(this.raw.header.LTM1_1)&&(n.bin=1/Math.abs(this.raw.header.LTM1_1));var t={x:this.raw.width/2,y:this.raw.height/2};t=this.imageToLogicalPos(t);n.xcen=Math.floor(t.x+.5*(n.bin-
1));n.ycen=Math.floor(t.y+.5*(n.bin-1));if(t=this.maybePhysicalToImage({x:n.xcen,y:n.ycen}))n.xcen=t.x,n.ycen=t.y;n.xdim=Math.floor(x.naxis1*n.bin);n.ydim=Math.floor(x.naxis2*n.bin);n.filter=this.raw.filter||"";n.columns=this.raw.columns||""}if("string"===typeof c.bin)switch(c.bin.match(/[as]$/)&&(c.binMode=c.bin.slice(-1),c.bin=c.bin.slice(0,-1)),t=n.bin||this.binning.bin,c.bin.charAt(0)){case "*":case "x":case "X":c.bin=t*parseFloat(c.bin.slice(1));break;case "/":c.bin=t/parseFloat(c.bin.slice(1));
break;case "i":case "I":c.bin=2*t;break;case "o":case "O":c.bin=t/2;break;default:a.isNumber(c.bin)?c.bin=parseFloat(c.bin):a.error("invalid bin for displaySection: "+c.bin)}c.xcen=p(c.xcen,n.xcen,0);c.ycen=p(c.ycen,n.ycen,0);switch(this.imtab){case "table":c.xdim=p(c.xdim,n.xdim,a.fits.options.table.xdim);c.ydim=p(c.ydim,n.ydim,a.fits.options.table.ydim);c.bin=p(c.bin,n.bin,a.fits.options.table.bin);break;default:c.xdim=p(c.xdim,n.xdim,a.fits.options.image.xdim),c.ydim=p(c.ydim,n.ydim,a.fits.options.image.ydim),
c.bin=p(c.bin,n.bin,a.fits.options.image.bin)}c.binMode=p(c.binMode,n.binMode,a.globalOpts.binMode);"string"===typeof c.bin&&(c.bin.match(/[as]$/)&&(c.binMode=c.bin.slice(-1)),c.bin=parseFloat(c.bin));c.bin||(c.bin=1);"image"===this.imtab&&0<c.bin&&1>c.bin&&(c.bin=1/Math.floor(1/c.bin+.5));c.filter=p(c.filter,n.filter,"");this.raw.filter=c.filter||"";c.columns=p(c.columns,n.columns,"");this.raw.columns=c.columns||"";!1!==c.waiting&&a.waiting(!0,this.display);this.setStatus("displaySection","processing");
window.setTimeout(function(){switch(f){case "parentFile":e=d.proxyFile;l=[];l.push({name:"xcen",value:c.xcen});delete c.xcen;l.push({name:"ycen",value:c.ycen});delete c.ycen;l.push({name:"xdim",value:c.xdim});l.push({name:"ydim",value:c.ydim});void 0!==c.xdim&&(c.xdim=0);void 0!==c.ydim&&(c.ydim=0);c.binMode&&(c.bin=""+c.bin+c.binMode,delete c.binMode);l.push({name:"bin",value:c.bin});delete c.bin;u=(c.filter||"")+"@@"+(c.cols||"");l.push({name:"filter",value:u});l.push({name:"slice",value:c.slice||
""});delete c.slice;g={id:d.expandMacro("$id"),image:d.file,fits:d.parentFile,rtype:"text"};g.cmd="js9Xeq imsection "+d.parentFile;c.extension&&(g.cmd=g.cmd.replace(/\[.*\]/,""),g.cmd+="["+c.extension+"]",delete c.extension);g.cmd+=d.expandMacro(" $xdim@$xcen,$ydim@$ycen,$bin $filter $slice",l);a.helper.send("imsection",g,function(b){b="object"===typeof b?b:0<=b.search(a.analOpts.epattern)?{stderr:b}:{stdout:b};if(b.stderr)a.error(b.stderr);else if(b.errcode)a.error("in displaySection: "+b.errcode);
else{var f=b.stdout.split(/\n/);b=a.cleanPath(f[0]);"/"!==b.charAt(0)&&(b=a.InstallDir(b));c.proxyFile=b;e&&e!==c.proxyFile&&d.removeProxyFile(e);if(f[1]){try{var g=JSON.parse(f[1])}catch(z){a.log("couldn't parse imsection as JSON: %s",b),g=null}g&&(c.extname=g.extname,c.extnum=g.extnum,c.hdus=g.hdus,c.binstr=g.binstr,c.parent=g)}f[2]&&(g=a.cleanPath(f[2]),c.parentFile=g);a.fetchURL(b,b,c,function(b){a.cleanupFITSFile(d.raw,!0);!1!==c.waiting&&a.waiting(!0,d.display);a.fits.handleFITSFile(b,c,r)})}});
...
d+" "+e);if(this.wcsAlign()||this.isawcsim){var k=a.globalOpts.panWithinDisplay;a.globalOpts.panWithinDisplay=!0}this.mkSection(d,e);if(this.wcsAlign()||this.isawcsim){for(g=0;g<a.images.length;g++)h=a.images[g],h!==this&&h.display===this.display&&(h.wcsim===this||this.wcsim===h||h.wcsim&&h.wcsim===this.wcsim)&&(h.params.wcsalign||this.params.wcsalign)&&(b=a.pix2pix(this,h,{x:d,y:e}),h.mkSection(b.x,b.y));a.globalOpts.panWithinDisplay=k}this.displayImage("rgb");this.refreshLayers();a.globalOpts.extendedPlugins&&
...
this.layers[b].opts.panzoom&&(a&&a[b]&&(a[b].refresh=!0),this.refreshShapes(b));this.selectShapes("regions","selected")};a.Image.prototype.imageToLogicalPos=function(a,b){var c="image",e=a.x;var f=a.y;b=b||this.params.lcs||"image";switch(b){case "physical":if(this.lcs.physical){c=b;var g=this.lcs.physical.reverse;var h=this.lcs.physical.rrot;var k=this.lcs.physical.cx;var m=this.lcs.physical.cy}break;case "detector":this.lcs.detector&&(c=b,g=this.lcs.detector.reverse,h=this.lcs.detector.rrot,k=this.lcs.detector.cx,
m=this.lcs.detector.cy);break;case "amplifier":this.lcs.amplifier&&(c=b,g=this.lcs.amplifier.reverse,h=this.lcs.amplifier.rrot,k=this.lcs.amplifier.cx,m=this.lcs.amplifier.cy)}g&&(e=a.x*g[0][0]+a.y*g[1][0]+g[2][0],f=a.x*g[0][1]+a.y*g[1][1]+g[2][1],h&&(a=k+(e-k)*h[0][0]+(f-m)*h[1][0]+h[2][0],f=m+(e-k)*h[0][1]+(f-m)*h[1][1]+h[2][1],e=a),"table"===this.imtab&&(h=0>this.raw.bitpix?.5:1,void 0!==this.raw.header.TABMIN1&&(e=e-h+this.raw.header.TABMIN1),void 0!==this.raw.header.TABMIN2&&(f=f-h+this.raw.header.TABMIN2)));
...
c))&&(this.params.wcssys=c.trim(),c=a.globalOpts.wcsUnits[this.params.wcssys]||"sexagesimal",this.setWCSUnits(c,b)),a.globalOpts.extendedPlugins&&this.xeqPlugins("image","onsetwcssys"),this};a.Image.prototype.initWCS=function(c){var b,d=a.globalOpts.wcsHlength;var e=/(WCSNAME|WCSAXES|CRVAL[0-9]|CRPIX[0-9]|PC[0-9]_[0-9]|CDELT[0-9]|CD[0-9]_[0-9]|CTYPE[0-9]|CUNIT[0-9]|CRVAL[0-9]|PV[0-9]_[0-9]|PS[0-9]_[0-9]|RADESYS|LONPOLE|LATPOLE)([A-Z])/;if(!this.raw.header)return this;c=c||this.raw.header;this.freeWCS();
this.raw.altwcs={};var f=(a.fits&&a.fits.wcsInitMode||a.wcsInitMode||"pointer").toString().trim().toLowerCase();"header"!==f&&(f="pointer");var g="default";this.raw.altwcs[g]={};this.raw.altwcs[g].header=c;var h=$jscomp.makeIterator(Object.keys(c));for(g=h.next();!g.done;g=h.next())g=g.value,(b=g.match(e))&&b.length&&(g=b[2],this.raw.altwcs[g]||(this.raw.altwcs[g]={},this.raw.altwcs[g].header=$.extend({},c)),"RADESYS"===b[1]&&(b[1]="RADECSYS"),this.raw.altwcs[g].header[b[1]]=c[b[0]]);c=$jscomp.makeIterator(Object.keys(this.raw.altwcs));
for(g=c.next();!g.done;g=c.next()){g=g.value;e=a.raw2FITS(this.raw.altwcs[g].header);if("header"===f)try{this.raw.altwcs[g].wcs=a.initwcs(e,d)}catch(m){this.raw.altwcs[g].wcs=0,a.error("can't initialize WCS from header string",m)}else{h=e.length+1;try{var k=a.vmalloc(h)}catch(m){a.error("can't malloc for wcsinit: "+h,m)}try{a.vstrcpy(e,k)}catch(m){a.error("can't copy for wcsinit: "+h,m)}this.raw.altwcs[g].wcs=a.initwcs(k,d);a.vfree(k)}if(0<this.raw.altwcs[g].wcs)try{this.raw.altwcs[g].wcsinfo=JSON.parse(a.wcsinfo(this.raw.altwcs[g].wcs))}catch(m){}}this.setWCS("default");
return this};a.Image.prototype.freeWCS=function(c){var b;c=c||this.raw;if(c.altwcs){var d=$jscomp.makeIterator(Object.keys(c.altwcs));for(b=d.next();!b.done;b=d.next())b=b.value,0<c.altwcs[b].wcs&&(a.freewcs(c.altwcs[b].wcs),c.altwcs[b].wcs=null)}};a.Image.prototype.getWCS=function(){var a;var b=$jscomp.makeIterator(Object.keys(this.raw.altwcs));for(a=b.next();!a.done;a=b.next())if(a=a.value,this.raw.wcs===this.raw.altwcs[a].wcs)return b=$.extend(!0,{},this.raw.altwcs[a].wcsinfo),b.version=a,b.wcsname=
this.raw.altwcs[a].header.WCSNAME,b;return null};a.Image.prototype.setWCS=function(c){var b;c=c||"default";if(!this.raw||!this.raw.altwcs)return this;var d=$jscomp.makeIterator(Object.keys(this.raw.altwcs));for(b=d.next();!b.done;b=d.next()){b=b.value;var e=this.raw.altwcs[b].header.WCSNAME;if(c===b||c===e)return 0>=this.raw.altwcs[b].wcs&&a.error("invalid WCS for version: %s",c),this.raw.wcs=this.raw.altwcs[b].wcs,this.raw.wcsinfo=this.raw.altwcs[b].wcsinfo,c=this.raw.wcsinfo&&this.raw.wcsinfo.radecsys?
...
h(m[1]);l=d.listRegions("source",{mode:0,includedcoords:a.globalOpts.regExpandDCoords}).replace(/\s+/g,"");c&&(d.params.wcssys=c);break;case "bregions":c=h(m[1]);l=d.listRegions("background",{mode:0,includedcoords:a.globalOpts.regExpandDCoords}).replace(/\s+/g,"");c&&(d.params.wcssys=c);break;case "regions":c=h(m[1]);l=d.listRegions("all",{mode:0,includedcoords:a.globalOpts.regExpandDCoords}).replace(/\s+/g,"");c&&(d.params.wcssys=c);break;case "mag":l=d.params.zoom?sprintf("%s%",100*d.params.zoom):
"?";break;case "bin":l=d.binning.bin?d.binning.bin:"?";break;case "flip":l=d.params.flip?d.params.flip:"?";break;case "flipx":l=d.params.flip?d.params.flip.match("x")?"x":"x-none":"?";break;case "flipy":l=d.params.flip?d.params.flip.match("y")?"y":"y-none":"?";break;default:if(b)for(e=b.length,h=0;h<e;h++)if(b[h].name===g){l=b[h].value;break}if(void 0===l&&d&&void 0!==d.params[g])switch(g){case "wcsunits":switch(d.params[g]){case "sexagesimal":l="hms";break;case "degrees":l="deg";break;default:l=
...
this.fitsFile;h.rtype=f.rtype;switch(a.helper.type){case "nodejs":case "socket.io":c=f.xclass?f.xclass+":"+f.name:f.name;break;default:c="runAnalysis"}a.waiting(!0,this.display);this.setStatus("runAnalysis","processing");a.helper.send(c,h,function(c){var l;var m="object"===typeof c?c:0<=c.search(a.analOpts.epattern)?{stderr:c}:{stdout:c};m.errcode=m.errcode||0;if(d)d.call(e,m.stdout,m.stderr,m.errcode,f);else{if(m.stderr)if(c=m.stderr,0<=c.search(/WARNING:/i)&&0>c.search(/ERROR:/i))a.log(c);else{k(c,
a.analOpts.epattern);return}else if(m.errcode)if(c="ERROR: running "+f.name+" ["+m.errcode+"]",m.stdout)a.log(c);else{k(c,a.analOpts.epattern);return}switch(f.rtype){case "text":case void 0:e.displayAnalysis("text",m.stdout,{divid:a.globalOpts.analysisDiv});break;case "plot":e.displayAnalysis("plot",m.stdout,{divid:a.globalOpts.analysisDiv});break;case "alert":m.stdout&&alert(m.stdout);break;case "fits":(l=m.stdout.split(/\s+/))&&l[0]&&(c=a.cleanPath(l[0]),"/"!==c.charAt(0)&&(c=a.InstallDir(c)),m=
{proxyFile:c},l[1]&&(l=a.cleanPath(l[1]),m.parentFile=l,m.proxyParent=l),m.fits2fits=!1,m.fixpath=!1,a.Load(c,m,{display:e.display}));break;case "regions":if((l=m.stdout.split(/\s+/))&&l[0]){if(1<l.length)try{g=JSON.parse(l[1])}catch(r){g=null}g=g||{};"boolean"===typeof g.remove&&(g.remove="all");"string"===g.type?(g.remove&&e.removeShapes("regions",g.remove),e.addShapes("regions",l[0],b)):(c=a.cleanPath(l[0]),"/"!==c.charAt(0)&&(c=a.InstallDir(c)),h={responseType:"text"},a.fetchURL(null,c,h,function(a,
b){g.remove&&e.removeShapes("regions",g.remove);e.addShapes("regions",a,b)}))}break;case "catalog":(l=m.stdout.split(/\s+/))&&l[0]&&(c=a.cleanPath(l[0]),h={responseType:"text"},a.fetchURL(null,c,h,function(a,b){e.loadCatalog(null,a,b)}));break;case "none":break;default:a.error("unknown analysis result type: "+f.rtype)}}e.setStatus("runAnalysis","complete");a.waiting(!1)});return this}a.error("could not find analysis task: "+c)}};a.Image.prototype.displayAnalysis=function(c,b,d){var e=this,f,g;var h=
a.lightOpts[a.LIGHTWIN];var k=function(){var b=a.Plot.opts.title;if(n&&u){$(a.lightOpts[a.LIGHTWIN].topid).arrive("#plotConfigForm",{onceOnly:!0},function(){a.Plot.initConfigForm.call(e,u,r)});var c=a.allinone?a.allinone.plotConfigHTML:a.InstallDir(a.Plot.opts.configURL);u.winid=e.displayAnalysis("params",c,{title:b,winformat:"width=368px,height=110px,resize=1,scrolling=1"})}};d=d||{};if("string"===typeof d)try{d=JSON.parse(d)}catch(x){a.error("can't parse displayAnalysis opts: "+d,x)}var m=d.winformat;
d.divid&&0<$("#"+d.divid).length&&(f=$("#"+d.divid));var l=d.title||"";this&&!l&&(d=this.fitsFile||this.id||"",d=d.split("/").reverse()[0],l="AnalysisResults: "+d+sprintf(a.IDFMT,this.display.id));d="Analysis_"+a.uniqueID();switch(c){case "text":b="<div class='JS9Analysis'></div><pre class='JS9AnalysisText'>"+((b||"")+"</pre></div>");if(f)f.html(b),window.electron&&a.searchbar(f[0]);else{m=m||h.textWin;var p=a.lightWin(d,"inline",b,l,m);window.electron&&a.searchbar(p)}break;case "plot":if(b&&"string"===
typeof b)try{var r=JSON.parse(b)}catch(x){a.error("can't plot return data: "+b,x)}else"object"===typeof b&&(r=b);if(!r)return;r.curscale={x:"linear",y:"linear"};b="<div id='"+d+"' class='JS9Analysis'><div id='"+d+"Plot' class='JS9Plot' ></div></div>";f?f.html(b):(m=m||h.plotWin,p=a.lightWin(d,"inline",b,l,m));var n=$("#"+d+" #"+d+"Plot");f&&(n.css("width",f.css("width")),n.css("height",f.css("height")),n.css("margin",0));if(r.data){switch(a.globalOpts.plotLibrary){case "plotly":h=$.extend(!0,{},a.Plot.opts,
r.opts);r.label&&(h.title=r.label);b={x:[],y:[],type:"scatter"};3<=r.data[0].length&&(b.error_y={type:"data",array:[],visible:!0},r.points&&r.points.yerr&&r.points.yerr.color&&(b.error_y.color=r.points.yerr.color));for(m=0;m<r.data.length;m++)b.x.push(r.data[m][0]),b.y.push(r.data[m][1]),b.error_y&&b.error_y.array&&b.error_y.array.push(r.data[m][2]);a.Plot.opts.annotate&&r.annotations&&(h.annotations=a.Plot.annotate(r));"log"===h.xscale&&(h.xaxis=h.xaxis||{},h.xaxis.type="log",h.xaxis.autorange=!0,
r.curscale.x="log");"log"===h.yscale&&(h.yaxis=h.yaxis||{},h.yaxis.type="log",h.yaxis.autorange=!0,r.curscale.y="log");try{Plotly.newPlot(n.attr("id"),[b],h)}catch(x){a.error("can't plot data (plotly)",x)}break;default:h=$.extend(!0,{},a.Plot.opts,r.opts);a.Plot.opts.annotate&&r.annotations&&(h.zoomStack.func=function(b,c){a.Plot.annotate(n,b,r)});r.color=r.color||h.color;"log"===r.xscale&&(h.xaxis=h.xaxis||{},h.xaxis.transform=a.Plot.logfunc,h.xaxis.inverseTransform=a.Plot.expfunc,r.curscale.x="log");
"log"===r.yscale&&(h.yaxis=h.yaxis||{},h.yaxis.transform=a.Plot.logfunc,h.yaxis.inverseTransform=a.Plot.expfunc,r.curscale.y="log");try{var u=$.plot(n,[r],h)}catch(x){a.error("can't plot data (flot)",x)}a.Plot.opts.annotate&&r.annotations&&a.Plot.annotate(n,u,r)}n.css("outline","none");n.attr("tabindex",0);n.on("keydown",function(b){b=a.eventToCharStr(b);switch(b){case "c":k();break;case "x":case "y":g="linear"!==r.curscale[b]?"linear":"log",a.Plot.rescale(n,u,r,b,g)}});m=$("<img src='"+a.InstallDir("images/gears.png")+
...
return this}};a.Image.prototype.getScale=function(){if(this.params.scale)return{scale:this.params.scale,scalemin:this.params.scalemin,scalemax:this.params.scalemax,scaleclipping:this.params.scaleclipping}};a.Image.prototype.setScale=function(c){for(var b=[],d=0;d<arguments.length;++d)b[d-0]=arguments[d];var e=this,f=$jscomp.makeIterator(b);d=f.next().value;var g=f.next().value;f=f.next().value;var h=function(b){a.scales.includes(b)?e.params.scale=b:"dataminmax"===b?(e.params.scaleclipping="dataminmax",
...
!Number.isNaN(b)&&Number.isFinite(b)&&(b<d.dmin&&(d.dmin=b),b>d.dmax&&(d.dmax=b));g&&(e.scalemin=d.dmin);h&&(e.scalemax=d.dmax);e.precision=a.floatPrecision(e.scalemin,e.scalemax);return this};a.Image.prototype.zscale=function(c){var b,d=function(b){return a.isNull(b)||void 0===b?null:$.isArray(b)?2<=b.length?[parseFloat(b[0]),parseFloat(b[1])]:null:"object"===typeof b?a.notNull(b.z1)&&a.notNull(b.z2)?[parseFloat(b.z1),parseFloat(b.z2)]:null:"string"===typeof b&&(b=b.trim().split(/\s+/),2<=b.length)?
[parseFloat(b[0]),parseFloat(b[1])]:null};if(!this.raw||!this.raw.data)return this;var e=this.raw.data;if(a.fits&&"function"===typeof a.fits.computeZscale)try{var f=a.fits.computeZscale(e,this.raw.width,this.raw.height,this.raw.bitpix,{contrast:this.params.zscalecontrast,numsamples:this.params.zscalesamples,perline:this.params.zscaleline});if(b=d(f)){var g=b[0];var h=b[1];if(Number.isFinite(g)&&Number.isFinite(h))return this.params.z1=g,this.params.z2=h,"zmax"===c?(this.params.scalemin=this.params.z1,
this.params.scalemax=this.raw.dmax):c&&(this.params.scalemin=this.params.z1,this.params.scalemax=this.params.z2),this.params.precision=a.floatPrecision(this.params.scalemin,this.params.scalemax),this}a.log("adapter computeZscale() returned invalid values, using fallback path")}catch(m){a.log("adapter computeZscale() failed, using fallback path",m)}if(!a.zscale)return this;b=e.length*e.BYTES_PER_ELEMENT;try{var k=a.vmalloc(b)}catch(m){a.error("image too large for zscale malloc: "+b,m)}try{a.vmemcpy(new Uint8Array(e.buffer),
k)}catch(m){a.error("can't copy image to zscale heap: "+b,m)}e=a.zscale(k,this.raw.width,this.raw.height,this.raw.bitpix,this.params.zscalecontrast,this.params.zscalesamples,this.params.zscaleline);a.vfree(k);b=e.trim().split(/\s+/);this.params.z1=parseFloat(b[0]);this.params.z2=parseFloat(b[1]);"zmax"===c?(this.params.scalemin=this.params.z1,this.params.scalemax=this.raw.dmax):c&&(this.params.scalemin=this.params.z1,this.params.scalemax=this.params.z2);this.params.precision=a.floatPrecision(this.params.scalemin,
this.params.scalemax);return this};a.Image.prototype.countsInRegions=function(c){for(var b=[],d=0;d<arguments.length;++d)b[d-0]=arguments[d];var e=this,f,g;d="field";var h="",k=function(b,c){var d=/(annulus|box|circle|ellipse|line|polygon|point|text) *\(/;if(!b)return c;if("string"===typeof b){var f=e.expandMacro(b);if(!f)return c;if(f.match(d))return f}(d=e.getShapes("regions",b))&&d.length||a.error("no regions found: "+b);f="";for(b=0;b<d.length;b++){var g=d[b];e.params.wcssys?(f||(f=g.wcssys||
""),f+="; "+g.wcsstr):(f||(f=g.imsys||""),f+="; "+g.imstr)}return f||c};this.raw.hdu&&this.raw.hdu.fits&&this.raw.hdu.fits.vfile||a.error("no virtual file available for regcnts: "+this.id);a.fits&&a.fits.capabilities&&a.fits.capabilities.analysis&&"function"===typeof a.regcnts||a.error("countsInRegions is not supported by the active FITS adapter");for(f=0;f<b.length;f++){var m=b[f];if("string"===typeof m&&"{"===m.charAt(0))try{b[f]=JSON.parse(m)}catch(p){a.error("can't parse JSON arg in regcnts: "+
...
b.slice(0,-1)+"&&"+m+"]":b+("["+m+"]")):3===this.raw.header.NAXIS&&0>f.search(/(^| )-c/)&&(f+=" -c "+(this.raw.hdu.slice||1));if(g.reduce&&!this.parentFile&&3>this.raw.header.NAXIS&&(m=this.fileDimensions(),m=Math.floor(Math.max(m.xdim,m.ydim)/g.dim+.5),1<m))if("table"===this.imtab)f+=" -b "+m;else{"function"!==typeof a.imsection&&a.error("countsInRegions image reduction requires imsection capability in the active FITS adapter");var l="bin"+m+"_"+b.split("/").reverse()[0];a.imsection(b,l,"0@0,0@0,"+
m,"");b=l}a.waiting(!0,this.display);m=a.regcnts(b,d,h,f);a.waiting(!1);l&&a.vunlink(l);(m.match(/^ERROR/)||m.match(/FITSIO status/))&&a.error(m);g.lightwin&&this.displayAnalysis("text",m,{divid:a.globalOpts.analysisDiv});return m};a.Image.prototype.radialProfile=function(c){for(var b=[],d=0;d<arguments.length;++d)b[d-0]=arguments[d];var e=[];var f={cmdswitches:"-G -j -r"};for(d=0;d<b.length;d++)if("object"===typeof b[d]){var g=$.extend(!0,{},b[d],f);e.push(g);var h=g}else e.push(b[d]);g||e.push(f);
h=h||{};if(d=this.countsInRegions.apply(this,$jscomp.arrayFromIterable(e)))try{var k=JSON.parse(d)}catch(m){a.error("can't parse regcnts JSON",m)}k&&k.columnUnits&&k.columnUnits.radii||a.error("no radii available for radial profile");d=k.columnUnits.radii;b=k.columnUnits.surfBrightness;g=h.color||"green";e=h.errorcolor||"red";h=a.isNull(h.errorbars)||h.errorbars?"y":"n";h={color:sprintf("%s",g),label:sprintf("surface brightness(%s) vs. radius(%s)",b,d),points:{errorbars:sprintf("%s",h),yerr:{show:"true",
color:sprintf("%s",e)}},data:[]};for(d=0;d<k.backgroundSubtractedResults.length;d++)b=k.backgroundSubtractedResults[d],("undefined"===b.radius2||"NA"===b.radius2||b.radius1>b.radius2)&&a.error("radial profile source region must be an annulus"),b=[(b.radius1+b.radius2)/2,b.surfBrightness,b.surfError],h.data.push(b);return this.displayAnalysis("plot",h,{divid:a.globalOpts.analysisDiv})};a.Image.prototype.plot3d=function(c,b,d){var e,f,g=[];this.raw.header&&3===this.raw.header.NAXIS||a.error("plot3d requires a data cube with 3 dimensions");
...
break;case -32:h.data=new Float32Array(f.height*f.width);break;case -64:h.data=new Float64Array(f.height*f.width);break;default:a.error("unsupported bitpix: "+d.bitpix)}var m=h.width*h.height;for(b=0;b<m;b++)h.data[b]=f.data[b];h.bitpix=d.bitpix}else switch(f.bitpix){case 8:h.data=new Uint8Array(f.data);break;case 16:h.data=new Int16Array(f.data);break;case -16:h.data=new Uint16Array(f.data);break;case 32:h.data=new Int32Array(f.data);break;case -32:h.data=new Float32Array(f.data);break;case -64:h.data=
new Float64Array(f.data);break;default:a.error("unsupported bitpix: "+f.bitpix)}h.id=k;h.from=d.from||h.from||"func"}e.call(this,f,h,d)&&(0<=g?this.raws[g]=h:this.raws.push(h),this.raw=h,this.raw.header.bitpix&&(this.raw.bitpix=this.raw.header.bitpix),!1!==d.dataminmax&&this.dataminmax(),d.updatewcs&&(this.initWCS(),this.initLCS()),d.resetpan&&this.setPan(),this.refreshLayers(),this.displayImage("all",d),this.reFlipRot());return!0};a.Image.prototype.gaussBlurData=function(c,b){void 0===c&&a.error("missing sigma value for gaussBlurData");
...
return b};if(c&&this!==c){a.fits&&a.fits.capabilities&&a.fits.capabilities.reprojection&&"function"===typeof a.reproject||a.error("reproject is not supported by the active FITS adapter");"function"===typeof a.vfile&&"function"===typeof a.vunlink||a.error("reproject requires virtual-file support in the active FITS adapter");this.raws&&this.raws[0]||a.error("no raw data for reprojection");var r=this.raws[0];r.header&&r.wcsinfo||a.error("no WCS info available for reprojection");b=b||{};var n=$.extend(!0,
{},r.header);var u=$jscomp.makeIterator(Object.keys(n));for(e=u.next();!e.done;e=u.next())e=e.value,m.test(e)&&delete n[e];if("object"===typeof c){c.raw&&c.raw.header?d=c.raw.header:c.BITPIX&&c.NAXIS1&&c.NAXIS2?d=c:a.error("invalid wcs object input to reproject()");u=$jscomp.makeIterator(Object.keys(d));for(e=u.next();!e.done;e=u.next())e=e.value,m.test(e)&&(k[e]=d[e]);n=$.extend(!0,{},k,n);if(!n.NAXIS||!n.NAXIS1||!n.NAXIS2)return;n.NAXIS1=Math.min(n.NAXIS1,a.globalOpts.image.xdim);n.NAXIS2=Math.min(n.NAXIS2,
a.globalOpts.image.ydim);k=a.raw2FITS(n,{addcr:!0});n="wcs_"+a.uniqueID()+".txt";a.vfile(n,k);a.globalOpts.reprojectLimits&&(k=a.globalOpts.image.xdim,m=a.globalOpts.image.ydim,e=a.globalOpts.image.xdim*a.globalOpts.image.ydim,r.header.NAXIS1*r.header.NAXIS2>e&&a.error("the max reproject size is "+k+" * "+m+". You can use the Bin/Filter/Section plugin to extract a section, then save it as FITS and reproject the smaller image."))}else n=c;try{if(!l.test(r.wcsinfo.ptype)){var x=p(r.header,r.wcsinfo);
var t="owcs_"+a.uniqueID()+".txt";a.vfile(t,a.raw2FITS(x,{addcr:!0}));var v="awcs_"+a.uniqueID()+".txt";var w=a.tanhdr(t,v,"");1<a.DEBUG&&a.log("tanhdr (input): %s %s -> %s",t,v,w);a.vunlink(t);0<=w.search(/\[struct stat="OK"/)&&(b.cmdswitches=b.cmdswitches||"",b.cmdswitches+=" -i "+v)}if(c.raw&&!l.test(c.raw.wcsinfo.ptype)||c.ptype&&!l.test(c.ptype)){x=p(d,c.raw.wcsinfo);t="owcs_"+a.uniqueID()+".txt";a.vfile(t,a.raw2FITS(x,{addcr:!0}));var q="awcs_"+a.uniqueID()+".txt";w=a.tanhdr(t,q,"");1<a.DEBUG&&
a.log("tanhdr (reproj): %s %s -> %s",t,q,w);a.vunlink(t);0<=w.search(/\[struct stat="OK"/)&&(a.vunlink(n),n=q)}}catch(C){}if(r.hdu&&r.hdu.fits.vfile)c=r.hdu.fits.vfile,r.hdu.fits.extname?c+="["+r.hdu.fits.extname+"]":r.hdu.fits.extnum&&0<r.hdu.fits.extnum&&(c+="["+r.hdu.fits.extnum+"]");else{var z=this.toArray();c=this.id.replace(/\.png$/,"_png.fits");a.vfile(c,z)}q=this.id.replace(/\[.*\]/,"").replace(/\.png$/i,".fits").replace(/\.fz$/i,"").replace(/\.gz$/i,"");q="reproj_"+a.uniqueID()+"_"+q;d=b.rawid||
"reproject";for(t=0;t<this.raws.length&&(x=this.raws[t],x.id!==d||!a.cleanupFITSFile(x,!0));t++);r.hdu&&"table"===r.hdu.imtab&&r.hdu.table&&!c.match(/\[bin /)&&(c.match(/\[EVENTS\]/)||(c+="[EVENTS]"),x=r.hdu.table,r=Math.floor(x.xcen-x.xdim/2+1),t=Math.floor(x.xcen+x.xdim/2),d=Math.floor(x.ycen-x.ydim/2+1),x=Math.floor(x.ycen+x.ydim/2),c+="[bin X="+r+":"+t+",Y="+d+":"+x+"]");try{var y=q.lastIndexOf(".");0<=y&&(f=q.substring(0,y)+"_area"+q.substring(y));var A=b.cmdswitches||"";A+=" -a 0 "+a.globalOpts.reprojSwitches;
w=a.reproject(c,q,n,A);1<a.DEBUG&&a.log("reproject: %s %s %s [%s] -> %s",c,q,n,A,w);a.vunlink(f);a.vunlink(n);v&&a.vunlink(v);z&&a.vunlink(c);0>w.search(/\[struct stat="OK"/)&&(h=!0,(g=w.match(/msg="(.*)"/))&&g[1]?a.error(g[1]+" (from mProjectPP)"):a.error(w))}catch(C){if(h)return;a.vunlink(f);a.vunlink(n);w?a.error(w):a.error("WCS reproject failed",C)}return q}};a.Image.prototype.reprojectData=function(c){for(var b=[],d=0;d<arguments.length;++d)b[d-0]=arguments[d];var e=this,f;d=$jscomp.makeIterator(b);
var g=d.next().value,h=d.next().value;if(g){a.fits&&a.fits.capabilities&&a.fits.capabilities.reprojection&&"function"===typeof a.reproject||a.error("reprojectData is not supported by the active FITS adapter");if("string"===typeof g){if("all"===g){for(b=0;b<a.images.length;b++)d=a.images[b],this.display.id===d.display.id&&d.reprojectData(this);return}(d=a.getImage(g))?g=d:a.error("unknown WCS for reproject: "+g)}if(this!==g){h=h||{};if("string"===typeof h)try{h=JSON.parse(h)}catch(k){a.error("can't parse reproject opts: "+
h,k)}h.rawid||this.xeqStashSave("reprojectData",b.slice(),"reproject");h.stash||(h.stash="reprojectData");a.waiting(!0,this.display);this.setStatus("reprojectData","processing");window.setTimeout(function(){var b=function(b){e.xeqPlugins("image","onreprojectdata");c=c||{};c.refreshRegions=!0;!1!==h.resetSection&&(c.resetSection=!0);h.lcsUseRota2&&(c.lcsUseRota2=!0);e.refreshImage(b,c);e.setStatus("reprojectData","complete");e.xeqStashCall(e.xeqstash,[h.stash,"reprojectData"]);if("function"===typeof h.onreproject)try{a.xeqByName(h.onreproject,
window,e)}catch(p){a.error("in onreproject callback",p,!1)}};h=h||{};b=h.reprojHandler||b;if(f=e.reproject(g,h)){var c=$.extend(!0,{},a.fits.options,h);c.rawid=c.rawid||"reproject";g.raw&&g.raw.header&&(c.wcsim=g);try{a.handleFITSFile(f,c,b)}catch(l){a.error("can't process reprojected FITS file",l)}}},a.SPINOUT);return this}}};a.Image.prototype.filterRGBImage=function(c){for(var b=[],d=0;d<arguments.length;++d)b[d-0]=arguments[d];d=$jscomp.makeIterator(b).next().value;if(!d)return Object.keys(a.ImageFilters);
switch(d){case "reset":return this.setColormap("reset"),this;case "median":d="medianFilter";break;case "edge":d="edgeDetect"}a.ImageFilters[d]||a.error("JS9 image filter '"+d+"' not available");this.xeqStashSave("filterRGBImage",b.slice());b.shift();b.unshift(this.display.context,this.rgb.img);try{a.ImageFilters[d].apply(a.ImageFilters,$jscomp.arrayFromIterable(b))}catch(e){a.error("JS9 image filter '"+d+"' failed",e)}this.displayImage("display");a.globalOpts.extendedPlugins&&this.xeqPlugins("image",
"onfilterrgbimage");return this};a.Image.prototype.moveToDisplay=function(c){var b,d=0,e=this.display;var f=a.lookupDisplay(c);c&&f||a.error("could not find display: "+c);this.display.clearMessage();this.display.context.clear();this.xeqPlugins("image","onimageclear");var g=$jscomp.makeIterator(Object.keys(e.layers));for(c=g.next();!c.done;c=g.next())c=c.value,"main"!==e.layers[c].dtype||f.layers[c]||f.newShapeLayer(c,e.layers[c].opts);if(f.image)for(g=$jscomp.makeIterator(Object.keys(f.layers)),c=
g.next();!c.done;c=g.next())c=c.value,"main"===f.layers[c].dtype&&f.image.showShapeLayer(c,!1,{local:!0});g=$jscomp.makeIterator(Object.keys(this.layers));for(c=g.next();!c.done;c=g.next()){c=c.value;var h=this.layers[c];(b=f.layers[c])?(this.showShapeLayer(c,!1,{local:!0}),h.dlayer=b,h.divjq=b.divjq,h.canvasjq=b.canvasjq,h.canvas=b.canvas):delete this.layers[c]}this.display=f;this.display.image=this;this.mkSection();this.displayImage("all");g=$jscomp.makeIterator(Object.keys(this.layers));for(c=
g.next();!c.done;c=g.next())c=c.value,this.showShapeLayer(c,!0,{local:!0});e.rgb.rim===this&&(e.rgb.rim=null,f.rgb.rim=this);e.rgb.gim===this&&(e.rgb.gim=null,f.rgb.gim=this);e.rgb.bim===this&&(e.rgb.bim=null,f.rgb.bim=this);e.image=null;this.refreshLayers();for(f=0;f<a.images.length;f++)if(c=a.images[f],e===c.display){c.display.image=null;c.displayImage("all");c.refreshLayers();d++;break}!d&&e.winid&&e.winid.close&&(f=$.inArray(e,a.displays),0<=f&&a.displays.splice(f,1),e.winid.close());return this};
a.Image.prototype.saveSession=function(c,b){var d,e,f,g,h,k,m=function(b){var c={};if(window.electron){var l=new RegExp("^"+window.electron.currentDir+"/");c.file=b.file.replace(l,"")}else c.file=b.file;c.dwidth=b.display.width;c.dheight=b.display.height;c.params=$.extend(!0,{},b.params);c.tmp={};"active"===b.tmp.gridStatus&&(c.tmp.gridStatus="active");h=b.imageToLogicalPos({x:b.rgb.sect.xcen,y:b.rgb.sect.ycen});(k=b.maybePhysicalToImage(h))&&(h=k);c.sect={};c.sect.xcen=h.x;c.sect.ycen=h.y;c.sect.xdim=
b.raw.width;c.sect.ydim=b.raw.height;c.sect.zoom=b.rgb.sect.zoom;c.layers=[];l=$jscomp.makeIterator(Object.keys(b.layers));for(var m=l.next();!m.done;m=l.next())g=m.value,d=b.layers[g],e=d.dlayer,"main"===e.dtype&&"crosshair"!==g&&"grid"!==g&&(f={},f.name=g,f.json=e.canvas.toJSON(e.el),f.dopts=$.extend(!0,{},e.opts),d.catalog&&(f.catalog=d.catalog),d.starbase&&(f.starbase=JSON.stringify(d.starbase)),c.layers.push(f)),e.canvas.forEachObject(function(b){b.params&&b.params.winid&&($(b.params.winid).is(":visible")?
...
f&&this.xeqstash[f-1]&&this.xeqstash[f-1].args[0]===b[0])return this.xeqstash.pop(),this;break;default:for(f=0;f<this.xeqstash.length;f++)if((g=this.xeqstash[f])&&g.func===c&&g.context===e)return g.args=b,this}this.xeqstash.push({func:c,args:b,id:d,context:e});return this};a.Image.prototype.xeqStashCall=function(c,b){var d=this,e,f=function(b,c){var e=c.context||"image";try{switch(e){case "image":d[b].apply(d,$jscomp.arrayFromIterable(c.args));break;case "display":d.display[b].apply(d.display,$jscomp.arrayFromIterable(c.args));
break;default:d[b].apply(d,$jscomp.arrayFromIterable(c.args))}}catch(p){a.error("error executing stash: "+b,p,!1)}};c=c||this.xeqstash;if($.isArray(c))for(e=0;e<c.length;e++){var g=c[e];var h=g.func;0<=$.inArray(h,b)||f(h,g)}else for(e=$jscomp.makeIterator(Object.keys(c)),h=e.next();!h.done;h=e.next())h=h.value,0<=$.inArray(h,b)||(g=c[h],f(h,g))};a.Image.prototype.xeqStashDiscard=function(a){var b,c;if(this.xeqstash)if($.isArray(this.xeqstash))for(b=this.xeqstash.length-1;0<=b;b--)a!==this.xeqstash[b].func&&
a!==this.xeqstash[b].id||this.xeqstash.splice(b,1);else for(b=$jscomp.makeIterator(Object.keys(this.xeqstash)),c=b.next();!c.done;c=b.next())c=c.value,a!==c&&a!==this.xeqstash[c].id||delete this.xeqstash[c]};a.Image.prototype.xeqPlugins=function(c,b,d){var e,f=function(a,b){a="JS9:"+a;$(document).trigger(a,b)};if(c&&b&&a.globalOpts.xeqPlugins){var g=this.display.pluginInstances||{};var h=$jscomp.makeIterator(Object.keys(g));for(e=h.next();!e.done;e=h.next()){e=e.value;e=g[e];var k=e.plugin.opts;if(e.isActive(b)&&
"function"===typeof k[b]){this.callingPlugin=b;switch(c){case "image":try{k[b].call(e,this),f(b,{im:this})}catch(l){e.errLog(b,l)}break;case "region":case "shape":try{k[b].call(e,this,d),f(b,{im:this,xreg:d})}catch(l){e.errLog(b,l)}break;case "keydown":case "keypress":var m=d.originalEvent||d;try{k[b].call(e,this,this.ipos,m),f(b,{im:this,ipos:this.ipos,evt:m})}catch(l){e.errLog(b,l)}break;case "mouse":if(!this.clickInRegion||k[b+"_inRegion"]){m=d.originalEvent||d;try{k[b].call(e,this,this.ipos,m),
f(b,{im:this,ipos:this.ipos,evt:m})}catch(l){e.errLog(b,l)}}}delete this.callingPlugin}}return this}};a.Image.prototype.uploadFITSFile=function(){var c=this,b,d=function(b){delete a.worker.uploadActive;window.setTimeout(function(){a.progress(!1)},1E3);b.stderr?a.error(b.stderr):b.stdout&&(c.fitsFile=b.stdout.trim(),c.proxyFile=c.fitsFile,a.globalOpts.prependJS9Dir&&!c.fitsFile.match(/^\${JS9_DIR}/)&&"/"!==c.fitsFile.charAt(0)&&(c.fitsFile="${JS9_DIR}/"+c.fitsFile),c.queryHelper("all"))};if(a.worker&&
("nodejs"===a.helper.type||"socket.io"===a.helper.type)&&this.raw.hdu&&this.raw.hdu.fits&&this.raw.hdu.fits.vfile){a.worker.uploadActive&&a.error("only one upload allowed at a time");var e=this.raw.hdu.fits.vfile;a.helper.send("quotacheck",null,function(f){(f.stderr||f.errcode)&&a.error(f.stderr||"from quotacheck: "+f.errcode);b=a.vread(e,"binary");a.worker.socketio(function(){a.worker.uploadActive=!0;a.progress(!0,c.display);a.worker.send("uploadFITS",[e,b],d,[b.buffer])})});return this}};a.Image.prototype.removeProxyFile=
...
this.height;this.divjq.attr("tabindex",0);this.canvas=document.createElement("canvas");this.canvasjq=$(this.canvas).addClass("JS9Image").attr("id",this.id+"Image").attr("width",this.width).attr("height",this.height).css("z-index",a.ZINDEX);this.displayConjq=$("<div>").addClass("JS9Container").attr("id",this.id+"DisplayConjq").css("z-index",a.ZINDEX).attr("tabindex","0").append(this.canvasjq).appendTo(this.divjq);a.allinone||(this.iconjq=$("<div>").addClass("JS9Logo").css("display","none").css("z-index",
a.ZINDEX+1).appendTo(this.divjq),this.iconimgjs=$("<img>").addClass("JS9Logo").attr("src",a.InstallDir(a.globalOpts.logo)).attr("alt","js9").attr("title","js9").appendTo(this.iconjq),a.globalOpts.logoDisplay&&this.iconjq.css("display","block"));a.globalOpts.resizeHandle&&{}.hasOwnProperty.call(window,"ResizeSensor")&&(this.divjq.css("resize","both").css("overflow","hidden"),a.bugs.webkit_resize&&(this.owidth=parseInt(this.divjq.css("width"),10),this.oheight=parseInt(this.divjq.css("height"),10),this.divjq.css("width",
...
c.name,p.message,a.strace(p))}break;case "new":a.error("external window support for plugins not yet implemented")}};a.Display.prototype.displayLoadForm=function(c){var b=this,d=a.globalOpts.localLoadFormat;"proxy"!==a.globalOpts.remoteLoadMethod||a.proxyAvailable()||(a.globalOpts.remoteLoadMethod="cgiproxy");var e=a.globalOpts.remoteLoadMethod;c=c||{local:!0,remote:!0};a.isNull(c.title)&&(c.title="",c.local&&(c.title="Open "),c.remote&&(c.title&&(c.title+="or "),c.title+="Retrieve "),c.title+="an Image ",
c.local&&(c.title+="or Auxiliary File"));c.winformat=c.winformat||"width=640px,height=300px,resize=1,scrolling=1";var f=a.allinone?a.allinone.loadHTML:a.InstallDir(a.globalOpts.loadURL);$(a.lightOpts[a.LIGHTWIN].topid).arrive(".loadForm",{onceOnly:!0},function(f){var h=$(f).data("localfile")||b.tmp.localfile;f=$(f).data("remotefile")||b.tmp.remotefile;c.local&&($(g).find(".localfile").removeClass("nodisplay"),$(g).find(".localdoc").removeClass("nodisplay"),h&&$(g).find('input[name="localfile"]').val(h),
$(g).find("input[value="+d+"]").click());c.remote&&($(g).find(".remotefile").removeClass("nodisplay"),$(g).find(".remotedoc").removeClass("nodisplay"),f&&$(g).find('input[name="remotefile"]').val(f),a.proxyAvailable()||$(g).find('input[value="proxy"]').prop("disabled",!0),$(g).find("input[value="+e+"]").click())});var g=a.Image.prototype.displayAnalysis.call(null,"params",f,c);$(g).data("dispid",this.id)};a.Display.prototype.resize=function(c,b,d){var e,f=function(a){a.left+=h;a.top+=k;a.setCoords()};
...
b);a.bugs.webkit_resize&&!this.resizing&&(this.owidth=Math.min(this.owidth,e),this.oheight=Math.min(this.oheight,b));0<=$.inArray("JS9Menubar",a.globalOpts.resizeDivs)&&(a.isNull(d.resizeMenubar)||d.resizeMenubar)&&(g=this.pluginInstances.JS9Menubar)&&$("#"+this.id+"Menubar").css("width",e);0<=$.inArray("JS9Toolbar",a.globalOpts.resizeDivs)&&(a.isNull(d.resizeToolbar)||d.resizeToolbar)&&(g=this.pluginInstances.JS9Toolbar)&&(g.divjq.attr("data-width",String(e)+"px"),a.Toolbar.init.call(g));0<=$.inArray("JS9Colorbar",
a.globalOpts.resizeDivs)&&(a.isNull(d.resizeColorbar)||d.resizeColorbar)&&(g=this.pluginInstances.JS9Colorbar)&&(g.divjq.attr("data-width",String(e)+"px"),a.Colorbar.init.call(g));0<=$.inArray("JS9Statusbar",a.globalOpts.resizeDivs)&&(a.isNull(d.resizeStatusbar)||d.resizeStatusbar)&&(g=this.pluginInstances.JS9Statusbar)&&($("#"+this.id+"Statusbar").css("width",e),g.statusBar&&g.statusBar.match(/\$colorbar/)&&!1!==d.resizeStatusbarColorbar&&(g.colorwidth=Math.max(g.colorwidth+c-m,a.Statusbar.COLORWIDTH),
a.Statusbar.display.call(g,this.image,{reinit:!0})));g=$jscomp.makeIterator(Object.keys(this.layers));for(c=g.next();!c.done;c=g.next())c=c.value,c=this.layers[c],"main"===c.dtype&&(c.divjq.css("width",e),c.divjq.css("height",b),c.canvasjq.attr("width",e),c.canvasjq.attr("height",b),c.canvas.setWidth(e),c.canvas.setHeight(b),c.canvas.calcOffset());for(e=0;e<a.images.length;e++)if(b=a.images[e],b.mkSection(),b.display&&this===b.display&&(b.resize?(b.resize.left+=h,b.resize.top+=k):b.resize={left:h,
top:k},b===b.display.image))for(g=$jscomp.makeIterator(Object.keys(b.layers)),c=g.next();!c.done;c=g.next())c=c.value,c=b.layers[c],"main"!==c.dlayer.type||c.json||(c.canvas.getObjects().forEach(f),c.canvas.renderAll());a.bugs.webkit_resize&&this.divjq.css("width",this.width+a.RESIZEFUDGE).css("height",this.height+a.RESIZEFUDGE);!this.image||!a.globalOpts.resizeRedisplay&&this.resizing||(this.image.displayImage("all",d),this.image.refreshLayers());d.center&&this.center();return this};a.Display.prototype.inResize=
function(c){return a.globalOpts.resizeHandle&&c.x+a.RESIZEDIST>=this.divjq.width()&&c.y+a.RESIZEDIST>=this.divjq.height()?!0:!1};a.Display.prototype.center=function(){var c=this.divjq,b;var d=c.offset().top;var e=c.height(),f=$(window).height();var g=c.offset().left;c=c.width();var h=$(window).width();for(b=0;b<a.globalOpts.centerDivs.length;b++){var k=a.globalOpts.centerDivs[b];this.pluginInstances[k]&&(k=this.pluginInstances[k].divjq,e+=k.height(),d=Math.min(k.offset().top,d))}d=e<f?d-(f/2-e/2):
d;g=c<h?g-(h/2-c/2):g;$("html, body").animate({scrollTop:d,scrollLeft:g},250);return this};a.Display.prototype.gather=function(c){var b;c=c||{};if("string"===typeof c)try{c=JSON.parse(c)}catch(g){a.error("can't parse gather opts: "+c,g)}var d=c.images||a.images;for(c=0;c<d.length;c++)if((b="number"===typeof d[c]?a.images[d[c]]:d[c])&&b.display!==this){var e=b.display;var f=e.divjq.closest(".JS9GridItem");b.moveToDisplay(this);0<f.length&&(b=$.inArray(e,a.displays),0<=b&&a.displays.splice(b,1),f.remove())}a.globalOpts.extendedPlugins&&
this.image&&this.image.xeqPlugins("image","ongatherdisplay")};a.Display.prototype.separate=function(c){var b=this,d,e,f,g=0,h=0,k=0,m=1,l,p,r,n,u,x,t,v,w,q,z,y,A,C,B,D={},E=/_sep[0-9][0-9]*/,F=a.globalOpts.separate,G=function(b,c,d){c||a.error("can't init separation ops: no 'from' id");l=d.layout||a.globalOpts.separate.layout||"auto";p=d.leftMargin||F.leftMargin||0;r=d.topMargin||F.topMargin||0;"auto"===l&&0<b.divjq.closest(".JS9GridContainer").length&&(l="grid");"grid"===l&&(CSS.supports("display",
"grid")?(f=b.divjq.closest(".JS9GridContainer"),0<f.length&&(n=f)):l="auto");switch(l){case "auto":k=1;h=0;break;case "horizontal":k=1;h=0;break;case "vertical":k=0;h=1;break;default:k=1,h=0}u=43;x=0;t=$("#"+c);v=$("#"+c+"Menubar");0<v.length&&(v.isactive="visible"===v.closest(".JS9PluginContainer").css("visibility"));w=$("#"+c+"Toolbar");0<w.length&&(w.isactive="visible"===w.closest(".JS9PluginContainer").css("visibility"));q=$("#"+c+"Statusbar");0<q.length&&(q.isactive="visible"===q.closest(".JS9PluginContainer").css("visibility"));
z=$("#"+c+"Colorbar");0<z.length&&!q.length&&(z.isactive="visible"===z.closest(".JS9PluginContainer").css("visibility"));0<t.length&&(y=t.width(),A=t.height(),C=t.offset().top-$(window).scrollTop()-5,B=t.offset().left-$(document).scrollLeft(),v.isactive&&(A+=v.height(),C-=v.height()),w.isactive&&(A+=w.height(),C-=w.height()),q.isactive?(A+=q.height(),C-=q.height()):z.isactive&&(A+=z.height(),C-=z.height(),C+=7))},J=function(a,b){if(a){if(0<t.length){var c="";v.isactive&&(c+=sprintf("<div class='JS9Menubar' id='%sMenubar' data-width=%s></div>",
b,t.width()));w.isactive&&(c+=sprintf("<div class='JS9Toolbar' id='%sToolbar' data-width=%s></div>",b,t.width()));c+=sprintf("<div class='JS9' id='%s' data-width=%s data-height=%s></div>",b,t.width(),t.height());q.isactive?c+=sprintf("<div style='margin-top: 2px;'><div class='JS9Statusbar' id='%sStatusbar' data-width=%s></div></div>",b,t.width()):z.isactive&&(c+=sprintf("<div style='margin-top: 2px;'><div class='JS9Colorbar' id='%sColorbar' data-width=%s></div></div>",b,t.width()))}"auto"===l&&B+
y*(k+.5)>window.innerWidth&&(h++,k=0);var d=sprintf("width=%s,height=%s,top=%s,left=%s,resize=1,scolling=1",y,A,C+(A+r+u)*h,B+(y+p+x)*k);"auto"===l||"horizontal"===l?k++:"vertical"===l&&h++}return{id:b,html:c,winopts:d}},I=function(f){var h;var k=g++;f.length>k?(k="number"===typeof f[k]?a.images[f[k]]:f[k])&&k.display===b?(k.displayImage("all"),void 0===d?(d=k.display.id,G(k.display,d,c),!1===c.firstinplace&&g--,I(f)):(e="string"===typeof c.idbase?h=c.idbase+m++:d.replace(E,"")+"_sep"+a.uniqueID(),
D[e]=k,k=J(d,e),h&&(k.id=h),"grid"===l?($("<div>").prop("id",k.id+"GridItem").addClass("JS9GridItem").append($(k.html)).appendTo(n),a.AddDivs(k.id),D[k.id].moveToDisplay(k.id),I(f)):($(a.lightOpts[a.LIGHTWIN].topid).arrive("#"+e,{onceOnly:!0},function(a){h=$(a).attr("id");window.setTimeout(function(){D[h].moveToDisplay(h);I(f)},0)}),a.LoadWindow(null,{id:k.id},"light",k.html,k.winopts)))):I(f):a.globalOpts.extendedPlugins&&b.image&&b.image.xeqPlugins("image","onseparatedisplay")};c=c||{};if("string"===
typeof c)try{c=JSON.parse(c)}catch(K){a.error("can't parse separate opts: "+c,K)}I(c.images||a.images)};a.Display.prototype.nextImage=function(c){var b,d=[],e=[];c=c||1;if(!this.image)return this;var f=this.image.pos;if(!a.globalOpts.nextImageMask)for(b=0;b<a.images.length;b++){var g=a.images[b];g.display===this&&g.mask.active&&g.mask.im&&e.push(g.mask.im)}for(b=0;b<a.images.length;b++)g=a.images[b],g.display===this&&(!a.globalOpts.nextImageMask&&0<=$.inArray(g,e)||d.push(g));if(1>=d.length)return this;
for(g=0;g<d.length&&this.image!==d[g];g++);for(c=g+c;c>=d.length;)c-=d.length;for(;0>c;)c+=d.length;g!==c&&(g=d[c],g.displayImage("all"),g.display.clearMessage(),f&&(f=g.displayToImagePos(f),g.valpos=null,g.valpos=g.updateValpos(f,!0)));return this};a.Display.prototype.loadSession=function(c,b){var d=this,e,f,g={},h=function(c){var e,h=function(){var b=v.canvas.getObjects();b&&"undefined"!==typeof b.length&&(c.layers[v.layerName].nshape=b.length+1);a.Fabric.updateChildren(v,null,"objects");c.refreshLayers()},
l=function(a,b){5>parseInt(a.version.slice(0,1),10)&&(b.startAngle&&(b.startAngle*=180/Math.PI),b.endAngle&&(b.endAngle*=180/Math.PI))};var k=g[c.file]||{};k.blend&&(c.blend=$.extend(!0,{},k.blend));k.tmp&&(c.tmp=$.extend(!0,{},k.tmp));k.wcsim&&(c.wcsim=a.lookupImage(k.wcsim));if(k.layers&&k.layers.length)for(e=0;e<k.layers.length;e++){var m=k.layers[e];var t=m.name;if(!(0<=$.inArray("regions",c.params.disable)&&"regions"===t)&&"crosshair"!==t&&"grid"!==t){var v=d.newShapeLayer(t,m.dopts);c.addShapes(t,
[]);v.canvas.loadFromJSON(m.json,h,l);m.catalog&&(c.layers[t].catalog=m.catalog);if(m.starbase)try{c.layers[t].starbase=JSON.parse(m.starbase)}catch(w){}}}c.tmp&&"active"===c.tmp.gridStatus&&c.displayCoordGrid(!0);a.notNull(f)&&(--f,0===f&&a.images.sort(function(a,b){var c=0,d=0;g[a.file]&&(c=g[a.file].i);g[b.file]&&(d=g[b.file].i);return c-d}));k.xeqstash&&c.xeqStashCall(k.xeqstash);a.globalOpts.extendedPlugins&&c.xeqPlugins("image","onsessionload");if("function"===typeof b.onsessionload)try{a.xeqByName(b.onsessionload,
window,c)}catch(w){a.error("in onsessionload callback",w,!1)}},k=function(c){c.file||a.error("session does not contain a filename");e=$.extend(!0,{},c);delete e.params.display;e.params.crosshair=!1;e.params.onload=h;c=e.file;e.sect&&(e.params.xcen=e.sect.xcen,e.params.ycen=e.sect.ycen,e.params.xdim=e.sect.xdim,e.params.ydim=e.sect.ydim,e.params.zoom=e.sect.zoom,delete e.sect);window.electron&&a.desktopOpts.sessionPath&&b.sessionPath&&"/"!==e.file.charAt(0)&&!e.file.match(a.URLEXP)&&(c=a.fixPath(b.sessionPath+
e.file,b));g[c]=e;a.Load(c,e.params,{display:d.id})},m=function(b){var c;b.globalOpts&&($.extend(!0,a.globalOpts,b.globalOpts),delete b.globalOpts);if(b.cmaps)for(c=0;c<b.cmaps.length;c++){var e=b.cmaps[c];if(e.name){var g=0<=$.inArray(e.name,a.globalOpts.topColormaps)?{toplevel:!0}:{toplevel:!1};a.AddColormap(e,g)}}if(b.images)for(f=b.images.length,c=0;c<b.images.length;c++)b.images[c].i=c,k(b.images[c]);else k(b);if(b.display)for(c=$jscomp.makeIterator(Object.keys(b.display)),e=c.next();!e.done;e=
c.next())switch(e=e.value,e){case "blendMode":a.BlendDisplay(b.display[e],{display:d});break;default:d[e]=b.display[e]}};b=b||{};if("string"===typeof b)try{b=JSON.parse(b)}catch(l){a.error("can't parse loadSession opts: "+b,l)}a.waiting(!0,this);"object"===typeof c?m(c):$.ajax({url:c,cache:!1,dataType:"json",mimeType:"application/json",async:!1,success:function(a){m(a)},error:function(b,d,e){a.error("could not load session: "+c,e)}});return this};a.Display.prototype.displayMessage=function(a,b,d){};
a.Display.prototype.clearMessage=function(a){};a.Display.prototype.createMosaic=function(c,b){var d=this,e,f,g,h,k=this.image,m=function(){var b;for(b=0;b<h.length;b++)a.vunlink(h[b])},l=function(b,c){var d;0>c.search(/\[struct stat="OK"/)&&(a.waiting(!1),m(),(d=c.match(/msg="(.*)"/))&&d[1]?a.error(d[1]+" (from "+b+")"):a.error(c||"unknown "+b+" failure"))},p=function(b,c){c=c||{};var e=$.extend(!0,{},c);!1!==c.waiting&&a.waiting(!0,d);e.display=d.id;b=new a.Image(b,e);k.setStatus("createMosaic",
"complete");b.setStatus("createMosaic","complete");a.waiting(!1);if(c.onmosaic)try{a.xeqByName(c.onmosaic,window,b)}catch(t){a.error("in create mosaic callback",t,!1)}},r=function(c){for(var d=[],e=0;e<arguments.length;++e)d[e-0]=arguments[e];if(b.verbose||1<a.DEBUG)d=sprintf.apply(null,$jscomp.arrayFromIterable(d)),a.log(d)};b=b||{};if("string"===typeof b)try{b=JSON.parse(b)}catch(n){a.error("can't parse createMosaic opts: "+b,n)}a.fits&&a.fits.capabilities&&a.fits.capabilities.reprojection&&"function"===
typeof a.reproject&&"function"===typeof a.madd&&"function"===typeof a.imgtbl&&"function"===typeof a.makehdr&&"function"===typeof a.shrinkhdr&&"function"===typeof a.imsection&&"function"===typeof a.vfile&&"function"===typeof a.vread&&"function"===typeof a.vsize&&"function"===typeof a.vunlink||a.error("createMosaic is not supported by the active FITS adapter");b.reduce=b.reduce||a.globalOpts.reduceMosaic;b.dim=b.dim||Math.max(a.globalOpts.image.xdim,a.globalOpts.image.ydim);if(c)if("string"===typeof c)if("current"===
...
f.id);a.waiting(!0,this);k.setStatus("createMosaic","processing");window.setTimeout(function(){var d=a.uniqueID();var f=function(a){return"mosaic_"+d+"_"+a};var k=f("in.lst");var t=f("in.tbl");var v=f("in.hdr");var w=f("bin.lst");var q=f("bin.tbl");var z=f("out.lst");var y=f("out.tbl");var A=f("out.hdr");f=c[0].id.replace(/\[.*\]/,"").replace(/\.fz$/i,"").replace(/\.gz$/i,"").replace(/\.fits$/i,"_mosaic.fits");var C=f.replace(/\.fits$/,"_area.fits");h=[k,t,v,w,q,z,y,A,C];C="|                                                    fname|\n|                                                     char|\n";
...
e.push(a)});b.radii=[];var g=[].concat($jscomp.arrayFromIterable(this.editAnnulus.ids));for(f=e.length-1;0<=f;f--){var h=e[f].params.id;for(c=g.length-1;0<=c;c--){var k=g[c];if(h===k){1E-6===e[f].pub.radius&&(e[f].pub.radius=0);b.radii.push(e[f].pub.radius);g.splice(c,1);break}}if(!g.length)break}b.radii.sort(function(a,b){return a-b})}this.changeShapes(a,this.editAnnulus.annulus,b);this.removeShapes(a,this.editAnnulus.ids);delete this.editAnnulus}};a.Fabric.updateChildren=function(c,b,d){var e,f,
g={};if("regions"===c.layerName)if("objects"===d){b=c.canvas.getObjects().reverse();c=b.length;do{for(d=0;c--;){var h=b[c];"group"!==h.type||h.params||(b.splice.apply(b,[c,1].concat($jscomp.arrayFromIterable(h.getObjects()))),d++)}c=b.length}while(d);b.forEach(function(a){a.params&&(a.params.parent||a.params.children.length)&&(g[a.params.id]=a)});b.forEach(function(a){if(a.params)for(a.params.parent&&(a.params.parent.obj=g[a.params.parent.id]),e=0;e<a.params.children.length;e++)a.params.children[e].obj=
g[a.params.children[e].id]})}else if(b&&b.params)if("deltas"===d)b.params.parent&&(h=b.params.parent,c=h.obj.left-b.left,b=h.obj.top-b.top,c!==h.dleft||b!==h.dtop?(h.dleft=c,h.dtop=b,h.moved=!0):delete h.moved);else for(e=0;e<b.params.children.length;e++){var k=b.params.children[e].obj;h=k.params.parent;switch(d){case "moving":k.left=b.left-h.dleft;k.top=b.top-h.dtop;break;case "rotating":for(f=b.angle;0>f;)f+=360;for(;360<=f;)f-=360;var m=f-h.lastangle;var l=a.rotatePoint({x:k.left,y:k.top},m,{x:b.left,
...
typeof a&&0!==a%1&&(a=Math.round(1E4*(a+1E-5))/1E4),String(a)},x=function(a){var b=String.fromCharCode(13,10);return"string"===typeof a?a.replace(/\\n/g,b):a};if(c&&c.pub)var t=c.pub.wcsconfig&&c.pub.wcsconfig.wcssys?c.pub.wcsconfig.wcssys:this.params.wcssys;else t=this.params.wcssys,c=n;var v=!1===c.params.changeable;b=b||{};if(c.params.winid)var w=c.params.winid;else b.winid&&(w=b.winid);if(w){var q="#"+$(w).attr("id")+" .regionsConfigForm ";if($(q).length){p=$(q).data("multi")?!0:b.multi;$(q+"."+
c.pub.shape).each(function(a,b){$(b).removeClass("nodisplay")});$(q+".val").each(function(b,l){g="";f=$(l).attr("name");switch(f){case "x":case "y":c.pub.lcs&&void 0!==c.pub.lcs[f]?g=u(c.pub.lcs[f]):void 0!==c.pub[f]&&(g=u(c.pub[f]));break;case "radii":c.pub.radii&&(g=!a.notWCS(t)&&c.pub.wcsconfig&&c.pub.wcsconfig.wcsstr?c.pub.wcsconfig.wcsstr.replace(/^annulus\(/,"").replace(/\)$/,"").split(",").slice(2).join(","):c.pub.imstr.replace(/^annulus\(/,"").replace(/\)$/,"").split(",").slice(2).join(","));
...
(g=u(c.pub[f]))}$(q+"[name='"+f+"']").prop("readonly",v);break;case "wcssys":case "savewcs":z=$(q).find("[name='"+f+"']");if(!z.find("option").length)for(e=0;e<a.wcssyss.length;e++)z.append("<option>"+a.wcssyss[e]+"</option>");h="savewcs"===f?a.globalOpts.regSaveWCS||t:t;z.find("option").each(function(a,b){h===b.value&&(g=b.value)});break;case "wcsunits":c.pub.wcsunits&&(g=c.pub.wcsunits);break;case "childtext":c.params.children&&0<c.params.children.length&&(g=x(c.params.children[0].obj.text));break;
...
c&&t?!1:b.pub.lcs&&void 0!==b.pub.lcs[c]?p(b.pub.lcs[c],d)?!0:!1:p(b.pub[c],d)||p(b.params[c],d)||p(b[c],d)?!0:!1},n=function(b){return"true"===b?!0:"false"===b?!1:a.isNumber(b)?parseFloat(b):b},u=function(a){var b=String.fromCharCode(13,10);return"string"===typeof a?a.replace(/\\n/g,b):a};this.lcs&&this.lcs.physical&&(f=Math.sqrt(Math.pow(this.lcs.physical.forward[0][0],2)+Math.pow(this.lcs.physical.forward[0][1],2)));if(b&&b.pub)var x=b.pub.wcsconfig&&b.pub.wcsconfig.wcssys?b.pub.wcsconfig.wcssys:
...
case "text":"text"===b.type&&r(b,v,w)&&(k[v]=u(w));break;case "selectfilter":if(w&&w!==$(c).data("selectfilter")){$(c).data("selectfilter",w);this.lookupGroup(w)?this.groupShapes(g,w):this.selectShapes(g,w);return}break;case "strokeDashes":if(""===w)k.strokeDashArray=[];else{var q=w.trim().split(/\s+/);if(t&&w||r(b,v,q))k.strokeDashArray=0===q.length?[]:q.map(function(a){return parseInt(a,10)})}break;case "strokeWidth":if(""===w)k[v]="";else if(a.isNumber(w))if(q=parseInt(w,10),0>=q)k[v]="";else if(t&&
...
a.saveAs(b,c):a.error("no saveAs() available to save region file");return this.tmp.saveregionsFile=c};a.Regions.unremoveRegions=function(){var a=this.regstack.pop();return a?this.addShapes("regions",a):null};a.Regions.changeRegionTags=function(a,b,d){var c;a=a||"all";b=b||[];d=d||[];$.isArray(b)||(b=b.split(",").map(function(a){return a.trim()}));$.isArray(d)||(d=d.split(",").map(function(a){return a.trim()}));var f=this.getShapes("regions",a);for(a=0;a<f.length;a++){var g=f[a].tags;var h=[];for(c=
...
b)};a.fetchURL.status="processing";try{f.send()}catch(h){a.error("request to load "+b+" failed",h)}};a.saveAs=function(c,b){var d;if(window.electron){(d=b.match(/.*\//))&&d[0]&&(d=d[0],a.SaveDir(d,{onceOnly:!0}));var e=b.split("/").reverse()[0];window.setTimeout(function(){try{saveAs(c,e)}catch(f){a.error("could not saveAs",f)}},a.TIMEOUT)}else try{saveAs(c,b)}catch(f){a.error("could not saveAs",f)}};a.fitsAdapters=a.fitsAdapters||{};a.fitsAdapterAliases=a.fitsAdapterAliases||{};a.fitsAdapterCapabilityDefaults=
{fits:!0,wcs:!1,scaling:!1,reprojection:!1,analysis:!1,compression:!1};a.fitsRuntimeMethodNames="vmalloc vfree vmemcpy vstrcpy vfile vread vunlink vsize vmount arrfile listhdu initwcs freewcs wcsinfo wcssys wcsunits pix2wcs wcs2pix reg2wcs saostrtod saodtostr saodtype zscale tanhdr reproject madd imgtbl makehdr shrinkhdr imsection regcnts".split(" ");a.fitsRuntimeValueNames=["vheap"];a.fitsRuntimeFallbacks=a.fitsRuntimeFallbacks||{};a.captureFITSRuntimeFallbacks=function(){var c;for(c=0;c<a.fitsRuntimeMethodNames.length;c++){var b=
a.fitsRuntimeMethodNames[c];a.fitsRuntimeFallbacks[b]=a[b]}for(c=0;c<a.fitsRuntimeValueNames.length;c++)b=a.fitsRuntimeValueNames[c],a.fitsRuntimeFallbacks[b]=a[b];a.wcsInitMode||(a.wcsInitMode="pointer")};a.bindFITSRuntime=function(c){var b;c=c||a.fits||{};for(b=0;b<a.fitsRuntimeMethodNames.length;b++){var d=a.fitsRuntimeMethodNames[b];var e=c[d];var f=a.fitsRuntimeFallbacks[d];"function"===typeof e?a[d]=e.bind(c):{}.hasOwnProperty.call(a.fitsRuntimeFallbacks,d)&&(a[d]=f)}for(b=0;b<a.fitsRuntimeValueNames.length;b++)d=
a.fitsRuntimeValueNames[b],e=c[d],f=a.fitsRuntimeFallbacks[d],void 0!==e?a[d]=e:{}.hasOwnProperty.call(a.fitsRuntimeFallbacks,d)&&(a[d]=f);c=(c.wcsInitMode||"").toString().trim().toLowerCase();a.wcsInitMode="header"===c?"header":"pointer"};a.resolveFITSAdapterName=function(c){return(c=(c||"").toString().trim().toLowerCase())?a.fitsAdapterAliases[c]||c:""};a.validateFITSAdapter=function(c,b){var d=[],e=["handleFITSFile","getFITSImage","cleanupFITSFile","maxFITSMemory"],f,g=function(a,b){if("boolean"===
typeof c.capabilities[a])return c.capabilities[a];for(a=0;a<b.length;a++)if("function"!==typeof c[b[a]])return!1;return!0};c&&"object"===typeof c||a.error("invalid FITS adapter '"+b+"': expected an object");for(f=0;f<e.length;f++){var h=e[f];"function"!==typeof c[h]&&d.push(h)}d.length&&a.error("invalid FITS adapter '"+b+"': missing method(s): "+d.join(", "));c.options=c.options||{};c.capabilities=$.extend({},a.fitsAdapterCapabilityDefaults,c.capabilities||{});c.capabilities.fits=g("fits",["handleFITSFile",
"getFITSImage","cleanupFITSFile","maxFITSMemory"]);c.capabilities.wcs=g("wcs",["initwcs","pix2wcs","wcs2pix"]);c.capabilities.scaling=g("scaling",["computeZscale"])||g("scaling",["zscale"]);c.capabilities.reprojection=g("reprojection",["reproject","madd","imgtbl","makehdr","shrinkhdr"]);c.capabilities.analysis=g("analysis",["regcnts"]);c.capabilities.compression=g("compression",["compress","decompress"]);return c};a.registerFITSAdapter=function(c,b,d){d=d||{};(c=a.resolveFITSAdapterName(c))||a.error("missing FITS adapter name in JS9.registerFITSAdapter()");
a.fitsAdapters[c]={name:c,factory:b,configure:d.configure};a.fitsAdapterAliases[c]=c;d=d.aliases||[];for(b=0;b<d.length;b++)d[b]&&(a.fitsAdapterAliases[d[b].toString().trim().toLowerCase()]=c);return c};a.unregisterFITSAdapter=function(c){c=a.resolveFITSAdapterName(c);var b=Object.keys(a.fitsAdapterAliases),d;if(!c)return!1;delete a.fitsAdapters[c];for(d=0;d<b.length;d++){var e=b[d];a.fitsAdapterAliases[e]===c&&delete a.fitsAdapterAliases[e]}return!0};a.listFITSAdapters=function(){return Object.keys(a.fitsAdapters).sort()};
a.useFITSAdapter=function(c,b){var d,e=a.resolveFITSAdapterName(c);if(!e)return null;c=a.fitsAdapters[e];if(!c)return null;"function"===typeof c.factory?d=c.factory(b||{}):c.factory&&"object"===typeof c.factory?d=c.factory:a.error("invalid FITS adapter '"+e+"': expected object or factory");a.validateFITSAdapter(d,e);"function"===typeof c.configure&&c.configure(d,b||{});a.fits=d;a.fits.ready=!0;a.fits.name=e;a.fits.options=a.fits.options||{};a.fits.options.error=a.error;a.fits.options.waiting=a.waiting;
"function"===typeof a.bindFITSRuntime&&a.bindFITSRuntime(a.fits);return e};a.fitsLibrary=function(c,b){var d;b=b||{};var e=function(c){if(b.silent)throw Error(c);a.error(c)};(function(){({}).hasOwnProperty.call(window,"Fixi")&&"function"===typeof Fixi.createRustWasmAdapter&&a.registerFITSAdapter("fixi",function(){return Fixi.createRustWasmAdapter()},{aliases:["fixi-js"],configure:function(b){b&&b.backend&&"function"===typeof Fixi.configureForJS9?Fixi.configureForJS9(b,{globalOpts:a.globalOpts,userFits:a.userOpts.fits,
handler:a.NewFitsImage,error:a.error,waiting:a.waiting,maxMemory:a.globalOpts.maxMemory,fitsCompliance:a.globalOpts.fitsCompliance}):(a.fits.options=a.fits.options||{},a.fits.options.handler=a.NewFitsImage,a.fits.options.error=a.error,a.userOpts.fits?(a.fits.options.extlist=a.userOpts.fits.extlist,a.fits.options.table={xdim:a.userOpts.fits.xdim,ydim:a.userOpts.fits.ydim,bin:a.userOpts.fits.bin||1},a.fits.options.image={xdim:a.userOpts.fits.ixdim||a.userOpts.fits.xmax,ydim:a.userOpts.fits.iydim||a.userOpts.fits.ymax,
...
1},a.notNull(a.globalOpts.image.xdim)?a.fits.options.image.xdim=a.globalOpts.image.xdim:a.notNull(a.globalOpts.xmax)&&(a.fits.options.image.xdim=a.globalOpts.xmax),a.notNull(a.globalOpts.image.ydim)?a.fits.options.image.ydim=a.globalOpts.image.ydim:a.notNull(a.globalOpts.ymax)&&(a.fits.options.image.ydim=a.globalOpts.ymax)),a.fits.maxFITSMemory&&a.globalOpts.maxMemory&&a.fits.maxFITSMemory(a.globalOpts.maxMemory))}})})();if(!c)return a.fits&&a.fits.name?a.fits.name:"";if(d=a.useFITSAdapter(c,{globalOpts:a.globalOpts,
userFits:a.userOpts.fits}))return d;switch(c.toString().toLowerCase()){case "fixi":case "fixi-js":({}).hasOwnProperty.call(window,"Fixi")||e("fixi library is not available");e("fixi rust/wasm backend is not available");break;case "cfitsio":e("legacy cfitsio backend is not available in this JS9 build");break;default:e("unknown fits library: "+c)}return""};a.handleFITSFile=function(c,b,d){a.fits.handleFITSFile?a.fits.handleFITSFile(c,b,d):a.error("no FITS module available to process FITS file")};a.cleanupFITSFile=
function(c,b){var d;a.hostFS&&(d=new RegExp("^"+a.hostFS));return a.fits.cleanupFITSFile&&c&&c.hdu&&c.hdu.fits?(d&&c.hdu.fits.vfile&&c.hdu.fits.vfile.match(d)&&(b=!1),a.fits.cleanupFITSFile(c.hdu.fits,b),!0):!1};a.handleImageFile=function(c,b,d){var e=new FileReader;b=$.extend(!0,{},a.fits.options,b);d=d||a.Load;e.onload=function(a){var e,f,k,m=new Image;m.onload=function(){var a=0;var g=document.createElement("canvas");var h=g.getContext("2d");var n=m.height,u=m.width;g.width=u;g.height=n;h.drawImage(m,
0,0);e=h.getImageData(0,0,u,n).data;f=new Float32Array(n*u);for(h=0;h<n;h++)for(g=0;g<u;g++){var x=.299*e[a]+.587*e[a+1]+.114*e[a+2];f[(n-h)*u+g]=x;a+=4}k={filename:c.name,naxis:2,axis:[0,u,n],bitpix:-32,bin:1,head:{SIMPLE:!0,BITPIX:-32,NAXIS:2,NAXIS1:u,NAXIS2:n},data:f,offscreen:m};k.dmin=Number.MAX_VALUE;k.dmax=Number.MIN_VALUE;for(a=0;a<n*u;a++)!Number.isNaN(k.data[a])&&Number.isFinite(k.data[a])&&(k.dmin=Math.min(k.dmin,k.data[a]),k.dmax=Math.max(k.dmax,k.data[a]));b.source="img";d(k,b)};m.src=
...
!1;if(!a.helper.js9helper)if(a.globalOpts.requireFits2Fits)a.error("js9helper not found for fits2fits processing");else return!1;if(!a.globalOpts.workDir)return a.globalOpts.requireFits2Fits&&a.error("can't run fits2fits without a workdir"),!1;var k=d.xdim||a.fits.options.image.xdim||a.fits.options.table.xdim;var m=d.ydim||a.fits.options.image.ydim||a.fits.options.table.ydim;var l=d.bin||a.fits.options.image.bin||a.fits.options.table.bin;var p=d.binMode||a.globalOpts.binMode;p="a"===p?"a":"";"string"===
typeof l&&(l.match(/[as]$/)&&(p=l.slice(-1)),l=parseInt(l,10));l=Math.max(1,l||1);a.notNull(d.xcen)&&a.notNull(d.ycen)?g.sect=k+"@"+d.xcen+","+m+"@"+d.ycen+","+l+p:g.sect=k+","+m+","+l+p;m=h.toLowerCase().split(/[>,]/);for(k=0;k<m.length;k++)switch(m[k]){case "size":m[k+1]&&(a.isNumber(m[k+1])&&(g.maxsize=1E6*parseFloat(m[k+1])),k++)}g.fits=a.cleanPath(b);g.parent=!0;a.waiting(!0,c);a.helper.send("fits2fits",g,function(b){b="object"===typeof b?b:0<=b.search(a.analOpts.epattern)?{stderr:b}:{stdout:b};
b.stderr&&a.error(b.stderr,a.analOpts.epattern);if(b.stdout){b.stdout.match(/^ERROR:/)&&(a.globalOpts.requireFits2Fits?a.error(b.stdout):b.stdout=g.fits);var h=b.stdout.split(/\n/);b=a.cleanPath(h[0]);if(b===g.fits)var k=$.extend(!0,{},d);else{"/"!==b.charAt(0)&&(b=a.InstallDir(b));k=$.extend(!0,{},d);delete k.xcen;delete k.ycen;delete k.bin;void 0!==k.xdim&&(k.xdim=0);void 0!==k.ydim&&(k.ydim=0);k.source="fits2fits";k.proxyFile=b;if(h[1]){try{f=JSON.parse(h[1])}catch(x){}f&&(k.extname=f.extname,
k.extnum=f.extnum,k.hdus=f.hdus,k.parent=f)}h[2]&&(h=a.cleanPath(h[2]),k.parentFile=h,k.extname?(k.parentFile=k.parentFile.replace(/\[.*\]/,""),k.parentFile+="["+k.extname+"]"):k.extnum&&0<k.extnum&&(k.parentFile=k.parentFile.replace(/\[.*\]/,""),k.parentFile.file+="["+k.extnum+"]"));e&&(k.onload=e)}k.fits2fits=!1;a.Load(b,k,{display:c})}});return!0};a.lookupColormap=function(c,b){var d;void 0===b&&(b=!0);c||(c=a.imageOpts.colormap);if(c)for(d=0;d<a.colormaps.length;d++)if(a.colormaps[d].name===c)return a.colormaps[d];
if(b)a.error("unknown colormap '"+c+"'");else return null};a.lookupCommand=function(c){var b;if(c){var d=c.toLowerCase();for(b=0;b<a.commands.length;b++)if(c=a.commands[b],c.name===d||c.alias===d||c.alias2===d)return c}return null};a.error=function(c){for(var b=[],d=0;d<arguments.length;++d)b[d-0]=arguments[d];var e=$jscomp.makeIterator(b);d=e.next().value;var f=e.next().value;e=e.next().value;var g,h,k,m="",l="",p=!0;a.waiting(!1);"processing"===a.fetchURL.status&&(a.fetchURL.status="error");for(h=
0;h<a.images.length;h++){var r=a.images[h];(k=r.status.cur)&&r.status[k]&&r.setStatus(k,"error")}"string"===typeof f?(f=d.match(f))?f[1]?d=f[1]:f[0]&&(d=f[0]):p=!1:"object"===typeof f&&(g=f);3>b.length&&(e=!0);if(p&&(g&&g.message?d+=" ("+g.message+")":d&&(g=Error(d)),(b=a.strace(g))&&(l="\n\nStacktrace:\n"+b),a.globalOpts.alerts&&(d&&"string"===typeof d&&0>d.search(/ERROR/)&&(m="JS9 ERROR: "),alert(m+(d+l))),e))throw g;};a.log=function(a){for(var b=[],c=0;c<arguments.length;++c)b[c-0]=arguments[c];
...
typeof c?c:c.which||c.keyCode;var g=String(f);({}).hasOwnProperty.call(d,g)&&(f=d[g]);f=!c.shiftKey&&65<=f&&90>=f?String.fromCharCode(f+32):!c.shiftKey&&{}.hasOwnProperty.call(b,f)?b[f]:c.shiftKey&&{}.hasOwnProperty.call(e,f)?e[f]:String.fromCharCode(f);a.specialKey(c)&&(f="M-"+f);return f};a.eventToDisplayPos=function(a,b){a||(a=window.event);if(a.target)var c=a.target;else a.srcElement&&(c=a.srcElement);3===c.nodeType&&(c=c.parentNode);b=b||$(c).offset();if(a.originalEvent)if(a.originalEvent.touches&&
...
if($.isArray(e)){e[0]||a.error("no color specified: "+c[b]);try{var f=tinycolor(e[0])}catch(h){a.error("invalid color: "+e[0])}a.isNull(e[1])?(e[1]=1,e[2]=Infinity):e[1]=""===e[1]?-Infinity:parseFloat(e[1]);a.isNull(e[2])?e[2]=e[1]:e[2]=""===e[2]?Infinity:parseFloat(e[2]);var g={active:!0,red:f._r,green:f._g,blue:f._b,alpha:255*f._a,min:e[1],max:e[2]};"string"===typeof e[0]&&(g.name=e[0])}else"object"===typeof e&&(g=e);d.push(g)}d.sort(function(a,b){return a.min-b.min});return d};a.lookupStaticColor=
function(a,b,d){var c={red:0,green:0,blue:0,alpha:0};if(a&&a.staticObj){c=a.params.nocolor||c;if(b<a.staticObj.colors[0].min)return c;if(d&&d[b])return d[b];a:{var f=a.staticObj.colors;for(var g,h,k=0,m=f.length-1;k<=m;)if(g=Math.floor((k+m)/2),h=f[g],b>=h.min&&b<=h.max){f=g;break a}else h.max<b?k=g+1:m=g-1;f=-1}0>f?a=c:(a=a.staticObj.colors[f],a.active||(a=c));d&&1E7>=b&&(d[b]=a);return a}return c};a.strtoscaled=function(c){c=a.saostrtod(c);var b=String.fromCharCode(a.saodtype());switch(b){case '"':c/=
...
(a.displays[d].pluginInstances[b.name]=g)}};for(c=0;c<a.plugins.length;c++)b(a.plugins[c])};a.initEmscripten=function(){a.fits&&a.fits.ready||function(c){if(!a.globalOpts.fixiURL||{}.hasOwnProperty.call(window,"Fixi"))c();else{var b=a.InstallDir(a.globalOpts.fixiURL);try{a.loadScript(b,c,c)}catch(d){c()}}}(function(){a.initFITS()})};a.initFITS=function(){var c,b,d=function(){a.helper.ready&&a.inited&&!a.readied&&$(document).trigger("JS9:ready",{status:"OK"})},e=function(){var b=a.globalOpts.fitsAdapter;
return a.notNull(b)&&String(b).trim()?String(b).trim():"fixi"},f=function(b){b=(b||"").toString().trim().toLowerCase();var c;if(!b)return"";if((c=a.resolveFITSAdapterName(b))&&c!==b)return c;switch(b){case "fixi-js":return"fixi";default:return b}},g=function(){if(window.electron&&a.hostFS&&"function"===typeof a.vmount)try{a.vmount("/",a.hostFS)||delete a.hostFS}catch(p){delete a.hostFS}},h=function(){return new Promise(function(d,e){({}).hasOwnProperty.call(window,"Fixi")?"function"!==typeof Fixi.init?
d():(c={fitsCompliance:a.globalOpts.fitsCompliance},a.globalOpts.fixiURL&&(b=a.InstallDir(a.globalOpts.fixiURL).replace(/[^/]*$/,""),c.baseURL=b),a.globalOpts.fixiWasmURL&&(c.wasmURL=a.InstallDir(a.globalOpts.fixiWasmURL)),Fixi.init(c).then(function(){d()}).catch(function(a){e(a)})):e(Error("fixi runtime not loaded"))})},k=function(b){if(!a.fitsLibrary(b,{silent:!0}))throw Error("unable to activate FITS adapter: "+b);},m=function(b){a.tmp.initFITSInProgress=!1;a.error("no FITS backend available (check fixi runtime and adapter configuration)",
b)},l=function(b,c,e){var n=function(a){l(b,c+1,a||e)};if(c>=b.length)m(e||Error("unknown FITS initialization failure"));else{var p=b[c];if("fixi"===f(p))h().then(function(){try{k(p),a.tmp.initFITSInProgress=!1,g(),d()}catch(t){n(t)}}).catch(function(a){n(a)});else try{k(p),a.tmp.initFITSInProgress=!1,g(),d()}catch(t){n(t)}}};a.fits&&a.fits.ready||a.tmp.initFITSInProgress||(a.tmp.initFITSInProgress=!0,function(){a.vmalloc=a.vmalloc||function(){a.error("virtual FITS memory operations are not available in the active FITS adapter")};
a.vfree=a.vfree||function(){};a.vheap=a.vheap||null;a.vmemcpy=a.vmemcpy||function(){};a.vstrcpy=a.vstrcpy||function(){};a.vfile=a.vfile||function(){a.error("virtual FITS files are not available in the active FITS adapter")};a.vread=a.vread||function(){return null};a.vunlink=a.vunlink||function(){};a.vsize=a.vsize||function(){return-1};a.vmount=a.vmount||function(){return 0};a.arrfile=a.arrfile||function(){return null};a.listhdu=a.listhdu||function(){return null};a.initwcs=a.initwcs||function(){return 0};
a.freewcs=a.freewcs||function(){return 0};a.wcsinfo=a.wcsinfo||function(){return null};a.wcssys=a.wcssys||function(){return null};a.wcsunits=a.wcsunits||function(){return null};a.pix2wcs=a.pix2wcs||function(){return""};a.wcs2pix=a.wcs2pix||function(){return""};a.reg2wcs=a.reg2wcs||function(){return""};a.saostrtod=a.saostrtod||function(a){return parseFloat(a||0)};a.saodtostr=a.saodtostr||function(a){return String(a)};a.saodtype=a.saodtype||function(){return 0};a.zscale=a.zscale||null;a.tanhdr=a.tanhdr||
null;a.reproject=a.reproject||null;a.madd=a.madd||null;a.imgtbl=a.imgtbl||null;a.makehdr=a.makehdr||null;a.shrinkhdr=a.shrinkhdr||null;a.imsection=a.imsection||null;a.regcnts=a.regcnts||null}(),"function"===typeof a.captureFITSRuntimeFallbacks&&a.captureFITSRuntimeFallbacks(),l(function(){var a=[],b={},c=function(c){c=(c||"").toString().trim();var d=f(c);c&&d&&!b[d]&&(b[d]=!0,a.push(c))};c(e());c("fixi");return a}(),0,null))};a.initColormaps=function(){({}).hasOwnProperty.call(a,"Colormap")&&(a.checkNew(new a.Colormap("grey",
...
function(){var a,b=0,d=[];for(a=0;200>a;a++,b++){var e=1-a/199;var f=360*e+270;var g=Math.abs(Math.sin(3.1416*e));for(e=Math.pow(1-e,1/3);360<=f;)f-=360;f/=60;var h=Math.floor(f);var k=f-h;f=e*(1-g);var m=e*(1-g*k);g=e*(1-g*(1-k));d[b]=[];switch(h){case 0:d[b].push(e);d[b].push(g);d[b].push(f);break;case 1:d[b].push(m);d[b].push(e);d[b].push(f);break;case 2:d[b].push(f);d[b].push(e);d[b].push(g);break;case 3:d[b].push(f);d[b].push(m);d[b].push(e);break;case 4:d[b].push(g);d[b].push(f);d[b].push(e);
...
.3098,0],[.93725,0,0],[.74902,0,.3098]])))};a.initCommands=function(){({}).hasOwnProperty.call(a,"Command")&&(a.checkNew(new a.Command({name:"analysis",alias:"run",help:"list/run analysis for current image",get:function(){var a,b,d="",e=this.image;if(e&&e.analysisPackages)for(b=0;b<e.analysisPackages.length;b++){var f=e.analysisPackages[b];for(a=0;a<f.length;a++){var g=f[a];d&&(d+=", ");var h=g.xclass?g.xclass+":"+g.name:g.name;d+=g.title+" ("+h+")"}b<e.analysisPackages.length-1&&(d+="\n")}return d},
set:function(c){var b,d=this.image;d&&((b=d.lookupAnalysis(c[0]))?b.purl?(c=d.displayAnalysis("params",a.InstallDir(b.purl),{title:b.title+": "+d.fitsFile}),$(c).data("dispid",d.display.id).data("aname",b.name)):d.runAnalysis(b.name):a.error("unknown analysis command '"+c[0]+"'"))}})),a.checkNew(new a.Command({name:"colormap",alias:"cmap",help:"set/get colormap for current image",get:function(){var a;if(a=this.image)return a=a.getColormap(),a.colormap+" "+a.contrast+" "+a.bias},set:function(a){var b=
